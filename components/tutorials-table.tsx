      ...
      <tbody>
        {tutorials.map((tutorial, index) => (
          <tr key={index} className="_m-0 _border-t _border-gray-300 _p-0 dark:_border-gray-600 even:_bg-gray-100 even:dark:_bg-gray-600/20">
            <td className="_m-0 _border _border-gray-300 _px-4 _py-2 dark:_border-gray-600"><ReactMarkdown>{tutorial.title}</ReactMarkdown></td>
            <td className="_m-0 _border _border-gray-300 _px-4 _py-2 dark:_border-gray-600"><Link href={tutorial.colabUrl}><ColabBadge /></Link></td>
            <td className="_m-0 _border _border-gray-300 _px-4 _py-2 dark:_border-gray-600"><ColabToGitHubLink colabUrl={tutorial.colabUrl} /></td>
          </tr>
        ))}
      </tbody>
    </table>
