...
const tutorials: Tutorial[] = [
  ...
  {
    title: '**MOSTLY AI vs. SDV comparison: single-table scenario**',
    colabUrl: 'https://colab.research.google.com/github/mostly-ai/mostlyai/blob/main/docs/tutorials/sdv-comparison/single-table-scenario/single-table-scenario.ipynb',
  },
  {
    title: '**MOSTLY AI vs. SDV comparison: sequential scenario**',
    colabUrl: 'https://colab.research.google.com/github/mostly-ai/mostlyai/blob/main/docs/tutorials/sdv-comparison/sequential-scenario/sequential-scenario.ipynb',
  },
];
