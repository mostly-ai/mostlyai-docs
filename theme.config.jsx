...
const searchConfig =
  process.env.NEXT_PUBLIC_ALGOLIA_SEARCH === "true"
    ...
    <div>
      <span className="mostlyai-logo">
        <a href="https://mostly.ai">
          <img
            src="/logo/MOSTLY.AI_logo_light_gradient.svg"
    ...
    return (
      <>
        <link
          rel="icon"
          type="image/x-icon"
          href="/favicon/MOSTLY-AI-Docs-favicon.svg"
        />
        <link rel="canonical" href={url} />
        <meta property="og:url" content={url} />
        <meta
          property="og:title"
          content={frontMatter.title || "MOSTLY AI Documentation"}
        />
        <meta
          property="og:description"
          content={frontMatter.description || "MOSTLY AI Documentation "}
        />
