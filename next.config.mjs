...
export default withNextra({
    ...
    redirects: async () => [
      ...
      {
        source: "/docs/datasets/us-census-na.csv.gz",
        destination: "/datasets/us-census-na.csv.gz",
        permanent: true
      },
      {
        source: "/docs/datasets/baseball.zip",
        destination: "/datasets/baseball.zip",
        permanent: true
      },
      {
        source: "/docs/datasets/insurance_claims.csv.gz",
      ...
      {
        source: "/datasets/quick-job-4-setting-number-of-training-generated-subjects",
        destination: "/synthetic-datasets",
        permanent: true
      },
      {
      ...
      {
        source: "/datasets/create-data-catalog-8-setting-number-training-generated-subjects",
        destination: "/synthetic-datasets",
        permanent: true
      },
      {
      ...
      },
      {
        ...
        destination: "/generators/configure/set-table-relationships/relationship-diagram",
        permanent: true
      },
      {
