...
2. From the **Create a new connector** window, select **Microsoft SQL Server**.
    <Image
        src="/docimages/connectors/sql-server/create-connector-02-select-sql-server.webp"
...
3. From the **New connector** window, configure the connector.
    ...
    6. For **Database**, enter the name of the database.
        <Image
            src="/docimages/connectors/sql-server/create-connector-03-configure-sql-server.webp" alt="Configure SQL Server connector"
            width={400}
            height={500}
        />
