...
2. From the **Create a new connector** window, select **Oracle Database**.
    <Image
        src="/docs/docimages/connectors/oracle/create-connector-02-select-oracle.webp"
        alt="Select Oracle connector"
        width={800}
        height={500}
    />
3. On the **Create Oracle connector** page, configure the connector.
    ...
    7. For **Connection type**, select whether you the connection uses **SID** or **Service name**.
        <Image
            src="/docs/docimages/connectors/oracle/create-connector-03-configure-oracle.webp"
            alt="Select Oracle connector"
            width={300}
            height={500}
        />
