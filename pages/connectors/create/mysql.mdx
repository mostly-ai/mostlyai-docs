...
2. From the **Create a new connector** window, select **MySQL**.
    <Image
        src="/docs/docimages/connectors/mysql/create-connector-02-select-mysql.webp"
        alt="Select MySQL connector"
        width={800}
        height={500}
    />
3. From the **New connector** window, configure the connector.
    ...
    5. For **Username** and **Password**, enter your MySQL database credentials.
        <Image
            src="/docs/docimages/connectors/mysql/create-connector-03-configure-mysql.webp"
            alt="Select MySQL connector"
            width={300}
            height={500}
        />
