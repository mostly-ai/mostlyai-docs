...
1. In Databricks, open the workspace that contains the SQL Warehouse you want to use.
    <Image
        src="/docimages/connectors/databricks/databricks-01-open-workspace.webp"
...
2. Configure the Databricks connector.
    ...
    7. For **Client secret**, enter your client secret.
        <Image
            src="/docimages/connectors/databricks/create-connector-04-authenticate-with-service-principal.webp"
