...
1. In Azure, select **Storage accounts** from the sidebar.
    <Image
        src="/docimages/connectors/azure/prereq-01-azure-sidebar-storage-accounts.webp"
...
2. Copy your storage account name.
    <Image
        src="/docimages/connectors/azure/prereq-02-azure-storage-account-name.webp"
...
4. For the access key you want to use, click **Show** and then **Copy to clipboard**.
    <Image
        src="/docimages/connectors/azure/prereq-03-azure-storage-account-copy-access-key.webp"
...
2. From the **Create a new connector** window, select **Microsoft Azure**.
    <Image
        src="/docimages/connectors/azure/create-connector-02-select-azure.webp"
...
3. On the **New connector** page, configure the connector.
    ...
    4. For **Account key**, enter your Azure account key.
        <Image
            src="/docimages/connectors/azure/create-connector-03-configure-azure.webp"
...
2. On the **New connector** page, configure the Azure connector with a Service principal account.
    ...
    6. For **Client secret**, enter your client secret.
        <Image
            src="/docimages/connectors/azure/create-connector-04-azure-with-service-principal.webp"
