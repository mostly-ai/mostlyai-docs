...
1. In Google Cloud BigQuery, open the main sidebar menu and select **APIs & Services** > **Enabled APIs & services**.
    <Image
        src="/docimages/connectors/bigquery/bigquery-apis-services.webp"
...
2. From the sidebar, select **Credentials**.
    <Image
        src="/docimages/connectors/bigquery/bigquery-sidebar-select-credentials.webp"
...
3. Click your service account.
    <Image
        src="/docimages/connectors/bigquery/bigquery-click-service-account.webp"
...
5. Click **ADD KEY** and select **Create new key**.
    <Image
        src="/docimages/connectors/bigquery/bigquery-click-add-key-select-new-key.webp"
...
6. In the prompt, select **JSON** and click **Create**.
    <Image
        src="/docimages/connectors/bigquery/bigquery-select-json-click-create.webp"
...
2. On the **Connect to cloud storage** tab, select **Google cloud storage**.
    <Image
        src="/docimages/connectors/google-cloud/create-connector-02-select-google-cloud.webp"
...
3. On the **Create Google cloud connector** page, configure the connector.
    ...
    3. For **Key file**, paste the contents of your Google Cloud Storage key file.
        <Image
            src="/docimages/connectors/google-cloud/create-connector-03-configure-gcp-bucket.webp" alt="Configure Google Cloud Storage bucket connector"
            width={300}
            height={500}
        />
