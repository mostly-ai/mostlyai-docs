...
2. From the **Create a new connector** window, select **S3 Storage**.
    <Image
        src="/docs/docimages/connectors/s3/create-connector-02-select-s3-storage.webp"
        alt="Select S3 Storage connector"
        width={800}
        height={500}
    />
3. From the **New connector** window, configure the connector.
    ...
    4. For **Secret key**, enter your AWS secret key.
        <Image
            src="/docs/docimages/connectors/s3/create-connector-03-configure-aws-bucket.webp"
            alt="Configure AWS S3 bucket connector"
            width={300}
            height={500}
        />
    5. For **Endpoint URL (optional)**, enter the endpoint URL of your S3-compatible storage service.
        <Callout>
        If you use Amazon S3, you can leave this field empty.<br /><br />
        ...
        <Image
            src="/docs/docimages/connectors/s3/create-connector-04-use-ssl.webp"
            alt="Configure AWS S3 bucket connector - Use SSL for encrypted connection"
            width={300}
            height={500}
        />
...
<Tabs.Tab>
If you use the Python SDK, create an AWS S3 connector with `mostly.connect()` and provide a connector configuration dictionary as shown below.
