...
6. In the prompt, select **JSON** and click **Create**.
    <Image src="/docimages/connectors/bigquery/bigquery-select-json-click-create.webp"
...
2. On the **Connect to database** tab, select **Google BigQuery**.
    <Image
        src="/docimages/connectors/bigquery/create-connector-02-select-bigquery.webp"
...
3. On the **Create BigQuery connector** page, configure the connector.
    ...
    3. In **Key file**, paste the contents of your BigQuery key file.
        <Image
            src="/docimages/connectors/bigquery/create-connector-03-configure-bigquery.webp"
