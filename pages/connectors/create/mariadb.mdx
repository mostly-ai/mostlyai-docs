...
2.  From the **Create a new connector** window, select **MariaDB**.
    <Image src="/docimages/connectors/mariadb/create-connector-02-select-mariadb.webp" alt="Select MariaDB connector" width={800} height={500} />
3.  From the **New connector** page, configure the connector.
    ...
    4. For **Port**, enter the database port.
       <Callout type="info">The default port for MariaDB databases is 3306.</Callout>
    5. For **Username** and **Password**, enter your MariaDB database credentials.
       <Image src="/docimages/connectors/mariadb/create-connector-03-configure-mariadb.webp" alt="Configure MariaDB connector" width={300} height={500} />
