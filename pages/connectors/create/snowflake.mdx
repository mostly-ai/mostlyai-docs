...
1. In Snowflake, open the **Account** menu in the lower left.
    <Image
        src="/docimages/connectors/snowflake/prerequisite-snowflake-open-account-menu.webp"
...
2. Copy the organization name and account name and put them together in an account identifier, separated with a dash.
    <Image
        src="/docimages/connectors/snowflake/prerequisite-snowflake-account-identifier.webp"
        alt="Open Snowflake account menu"
        width={275}
        height={500}
    />
...
1. In Snowflake, select **Admin** > **Accounts**.
    <Image
        src="/docimages/connectors/snowflake/prerequisite-snowflake-admin-accounts.webp"
...
2. Under **Accounts**, hover over your account identifier and click **Copy account URL** link.
    <Image
        src="/docimages/connectors/snowflake/prerequisite-copy-snowflake-account-url.webp"
...
2. From the **Create a new connector** window, select **Snowflake**.
    <Image
        src="/docimages/connectors/snowflake/create-connector-02-select-snowflake.webp"
...
4. From the **New connector** window, configure the Snowflake connector.
    ...
    6. For **Warehouse**, enter the warehouse you want to use.
        ...
        <Image
            src="/docimages/connectors/snowflake/create-connector-03-configure.webp"
