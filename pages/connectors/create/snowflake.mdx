...
Account identifier format: *`<org_name>-<account_name>`*<br />
Account identifier URL format:
    *`https://<org_name>-<account_name>.snowflakecomputing.com`*
    <Callout type="info">
        For more information, see the [Snowflake documentation](https://docs.snowflake.com/en/user-guide/admin-account-identifier).
    </Callout>
...
1. In Snowflake, open the **Account** menu in the lower left.
    <Image
        src="/docs/docimages/connectors/snowflake/prerequisite-snowflake-open-account-menu.webp"
        alt="Open Snowflake account menu"
        width={200}
        height={500}
    />
2. Copy the organization name and account name and put them together in an account identifier, separated with a dash.
    <Image
        src="/docs/docimages/connectors/snowflake/prerequisite-snowflake-account-identifier.webp"
        alt="Open Snowflake account menu"
        width={275}
        height={500}
    />
...
1. In Snowflake, select **Admin** > **Accounts**.
    <Image
        src="/docs/docimages/connectors/snowflake/prerequisite-snowflake-admin-accounts.webp"
        alt="Snowflake open Admin > Accounts"
        width={250}
        height={500}
    />
2. Under **Accounts**, hover over your account identifier and click **Copy account URL** link.
    <Image
        src="/docs/docimages/connectors/snowflake/prerequisite-copy-snowflake-account-url.webp"
        alt="Copy Snowflake account URL"
        width={450}
        height={500}
    />
...
2. From the **Create a new connector** window, select **Snowflake**.
    <Image
        src="/docs/docimages/connectors/snowflake/create-connector-02-select-snowflake.webp"
        alt="Select Snowflake and click Proceed"
        width={800}
        height={500}
    />
4. From the **New connector** window, configure the Snowflake connector.
    ...
    6. For **Warehouse**, enter the warehouse you want to use.
        <Callout type="info">
            By default, MOSTLY AI uses the default Snowflake warehouse **`COMPUTE_WH`**.
        </Callout>
        <Image
            src="/docs/docimages/connectors/snowflake/create-connector-03-configure.webp"
            alt="Configure Snowflake connector"
            width={600}
            height={500}
        />
5. Click **Save**.<br /><br />
