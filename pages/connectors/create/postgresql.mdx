...
2. From the **Create a new connector** window, select **PostgreSQL**.
    <Image
        src="/docs/docimages/connectors/postgresql/create-connector-02-select-postgresql.webp"
...
3. From the **New connector** window, configure the connector.
    ...
    6. For **Database**, enter the name of the database.
        <Image
            src="/docs/docimages/connectors/postgresql/create-connector-03-configure-postgresql.webp" alt="Configure PostgreSQL connector"
            width={350}
            height={500}
        />
4. To use an encrypted connection to the database, select **Use SSL**.
    ...
    3. For **SSL certificate key**, upload your client private key.
        <Image
            src="/docs/docimages/connectors/postgresql/create-connector-04-enable-ssl.webp"
            alt="Configure PostgreSQL SSL connection"
            width={400} 
            height={500}
        />
