...
<Image
    src="/docs/docimages/connectors/connector-destination.webp"
    alt="Connector - Select Destination under Connector type"
    width={350}
    height={30} 
/>
...
3. Click **Dataset destination**.
    <Image
        src="/docs/docimages/connectors/destination/click-dataset-destination.webp"
...
3. In the modal window, select a destination connector from the **Destination** drop-down.
    <Image
        src="/docs/docimages/connectors/destination/select-destination-connector.webp"
...
4. For **Location**, follow the steps depending on whether you deliver to a database or cloud storage destination.
    * For databases, select a database and in which schema you want to deliver the synthetic dataset.
        <Image
            src="/docs/docimages/connectors/destination/destination-database-select-location.webp"
    ...
    * For cloud storage, click in the **Location** field and expand the bucket tree structure to select a destination folder.
        <Image
            src="/docs/docimages/connectors/destination/destination-cloud-storage-tree-view-select-location.webp"
