...
<Tabs items={['UI', 'Local environment', 'Remote platform']}>
<Tabs.Tab>
...
To export a generator, you must be its `Owner` or have the `Editor` role if the generator was shared with you.
...
<Tabs.Tab>
If you trained a generator in a local environment with the Python SDK, you can export it to a ZIP archive with the `export_to_file()` method.

Optionally, you can specify a filename for the exported generator.
...
<Tabs.Tab>
If you use the Python SDK with a remote Platform instance, you can export a generator from the Platform. Use the same `export_to_file()` method as you would in a local environment.

```python filename="python" copy
g = mostly_remote.generators.get('INSERT_GENERATOR_ID')
...
<Tabs.Tab>
If you use the Python SDK in a local environment, you can import a generator with the `mostly.generators.import_from_file` method.
```python filename="python" copy
g = mostly.generators.import_from_file('path/to/generator.zip')
```
</Tabs.Tab>
<Tabs.Tab>
If you use the Python SDK with a remote Platform instance, you can again use the `mostly_remote.generators.import_from_file` method to import a generator.
```python filename="python" copy
