...
<Image
    src="/docs/docimages/generators/evaluate-quality/01-generator-page-01-accuracy.webp"
    alt="MOSTLY AI - Generator details - Accuracy"
    width={900}
    height={300}
/>
...
<Image
    src="/docs/docimages/generators/evaluate-quality/01-generator-page-02-open-model-report.webp"
    alt="MOSTLY AI - Generator configuration - Open model report"
    width={900}
    height={300}
/>
...
<Image
    src="/docs/docimages/generators/evaluate-quality/qa-report-distances.webp"
    alt="Top QA report card" 
    width={800} 
    height={150}
/>
...
<Image 
    src="/docs/docimages/generators/evaluate-quality/02-open-model-report.webp" 
    alt="Top QA report card" 
    width={800} 
    height={150}
/>
...
<Image 
    src="/docs/docimages/generators/evaluate-quality/03-model-report-top.webp" 
...
| ----------------- | ----------- |
| **Identical<br />Matches** | An **identical match** is the special case of the distance measure being zero. In such a case, two records would share the same values across all columns. But also here, the occurrence of identical matches only represents a privacy issue if and only if it is more prevalent than within the training data itself. If the training dataset has identical matches, we can expect to see a similar number (but not significantly more) of identical matches in the synthetic data. |
| **Average Distances** | The average distances calculated between the synthetic records and their nearest neighbors from the training dataset used for this model.<br />For reference, the average distances between the synthetic records and their nearest neighbors from the holdout dataset appear in light gray. |
...
<Image 
    src="/docs/docimages/generators/evaluate-quality/qa-report-correlations-subject-table.webp" 
    alt="Correlations - Subject table" 
    width={800} 
    height={150}
/>
...
<Image 
    src="/docs/docimages/generators/evaluate-quality/qa-report-correlations-linked-table.webp" 
    alt="Correlations - Linked table" 
    width={800} 
    height={150}
/>
...
Details about the Φκ coefficient can be found in the following paper: [A new correlation coefficient between categorical, ordinal and interval variables with Pearson characteristics](https://arxiv.org/abs/1811.11440)
</CustomCallout>
...
<Image 
    src="/docs/docimages/generators/evaluate-quality/qa-report-univariate.webp" 
    alt="QA report - Univariate distributions" 
    width={600} 
    height={150}
/>
...
<Image 
    src="/docs/docimages/generators/evaluate-quality/qa-report-bivariate.webp" 
    alt="QA report - Bivariate distributions" 
    width={350} 
    height={150}
/>
...
<Image 
    src="/docs/docimages/generators/evaluate-quality/coherence-chart.webp" 
    alt="QA report - Coherence" 
    width={400} 
    height={150}
/>
...
<Image
    src="/docs/docimages/generators/evaluate-quality/qa-report-accuracy-section.webp" 
    alt="QA report - Accuracy section" 
    width={800} 
    height={150}
/>
...
<Image 
    src="/docs/docimages/generators/evaluate-quality/qa-report-accuracy.webp" 
    alt="QA report - Accuracy matrix"
    width={400} 
    height={150}
/>
...
<Image
    src="/docs/docimages/generators/evaluate-quality/similarity-plots.webp"
    alt="Model report - Similarity plots" 
    width={800} 
    height={150}
/>
...
The distances of the **_synthetic samples to the training samples_** are displayed in **_green_**, and the distances of the **_synthetic samples to the holdout samples_** are displayed in **_gray_**. 
...
<Image 
    src="/docs/docimages/generators/evaluate-quality/model-report-distances.webp" 
    alt="Model report - Distances" 
    width={650} 
    height={150}
/>
...
<Image
    src="/docs/docimages/generators/evaluate-quality/disable-model-report.webp"
    alt="MOSTLY AI - Generator configuration - Disable model report"
    width={900}
    height={300}
/>
...
```json
{
    ...
    'similarity': {
        'cosine_similarity_training_synthetic': 0.99995,
        'cosine_similarity_training_holdout': 0.99998,
        'discriminator_auc_training_synthetic': 0.531,
        'discriminator_auc_training_holdout': 0.506
    }
}
```
...
```json
{
    ...
    'similarity': {
        'cosine_similarity_training_synthetic': 0.99927,
        'cosine_similarity_training_holdout': 0.99921,
        'discriminator_auc_training_synthetic': 0.535,
        'discriminator_auc_training_holdout': 0.516
    }
}
```
