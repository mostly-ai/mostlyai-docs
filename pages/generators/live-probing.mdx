---
title: 'Live probing'
description: 'You can use the MOSTLY AI Synthetic Data SDK to probe a trained generator for a number of synthetic samples in real-time without the need to generate a synthetic dataset.'
---

# Live probing of generators

You can use the MOSTLY AI Synthetic Data SDK to probe a trained generator for a number of synthetic samples in real-time without the need to generate a synthetic dataset.
