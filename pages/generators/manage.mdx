...
* Clone a generator directly from the **Generators** page.
    1. From the **Generators** page, click the kebab menu of a generator, and select **Clone**.
        <Image
            src="/docimages/generators/manage/clone-from-generators-page.webp"
...
* Clone a generator after you open it.
    ...
    2. Click the kebab menu in the upper right, and select **Clone**.
        <Image
            src="/docimages/generators/manage/clone-from-generator-details.webp"
...
<Image
    src="/docimages/generators/manage/cloned-generator-result-name.webp"
...
1. Continue the training of a generator in one of two ways.
    * From the **Generators** page, click the kebab menu of a generator, and select **Clone**.
        <Image
            src="/docimages/generators/manage/continue-training-01-generators-page-kebab-menu.webp"
    ...
    * With a generator open, click the kebab menu in the upper right, and select **Clone**.
        <Image
            src="/docimages/generators/manage/continue-training-02-opened-generator.webp"
...
2. (Optional) Click a table to expand its model and training options and adjust as needed.
    <Image
        src="/docimages/generators/manage/continue-training-03-configure-model-training.webp"
...
3. Click **Continue training** to continue the training of the generator.
    <Image
        src="/docimages/generators/manage/continue-training-04-click-continue-training.webp"
...
<Image
    src="/docimages/generators/manage/continue-training-05-result.webp"
