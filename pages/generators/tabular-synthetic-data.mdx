...
<br />
<Image 
    src="/docs/docimages/concepts/tabular-sd/table-setups-legend.svg" 
    alt="Legend" 
    width={400} 
    height={150}
/>
...
<Image 
    src="/docs/docimages/concepts/tabular-sd/single-subject-table.svg" 
    alt="Two-table setup" 
    width={150} 
    height={150}
/>
...
<Image 
    src="/docs/docimages/concepts/tabular-sd/two-table-setup.svg" 
    alt="Two-table setup" 
    width={400} 
    height={150}
/>
...
| <GreenTickSign/> | Correlations between all columns are retained |
| <GreenTickSign/> | Correlations between events of the same customer are retained |
| <GreenTickSign/> | Privacy of customers is protected |

### Three tables - Star schema

<Image 
    src="/docs/docimages/concepts/tabular-sd/three-table-star-schema.svg" 
    alt="Three tables - Star schema" 
    width={450} 
    height={150}
/>
...
| -- | -- |
| <GreenTickSign/> | Referential integrity is preserved |
| <GreenTickSign/> | Correlations between customers and clicks are retained |
| <GreenTickSign/> | Correlations between customers and visits are retained |
| <GreenTickSign/> | Correlations between clicks and visits are retained |
| <GreenTickSign/> | Correlations between all clicks of the same customer are retained |
| <GreenTickSign/> | Correlations between all visits of the same customer are retained |
| <GreenTickSign/> | Correlations between events of the same customer are retained |
| <GreenTickSign/> | Privacy of customers is protected |
...
<Image 
    src="/docs/docimages/concepts/tabular-sd/three-table-nested-schema.svg" 
    alt="Three tables - Nested schema" 
    width={450} 
    height={150}
/>
...
| -- | -- |
| <GreenTickSign/> | Referential integrity is preserved |
| <GreenTickSign/> | Correlations between customers and accounts and between accounts and transactions are retained |
| <GreenTickSign/> | Correlations between customers and transactions are retained |
| <GreenTickSign/> | Correlations between all accounts of the same customer are retained |
| <GreenTickSign/> | Correlations between all transactions of the same customer are retained |
| <YellowWarningSign/> | Correlations between transactions across accounts are NOT retained |
| <GreenTickSign/> | Privacy of all entities is protected |

### Graph schemas - Non-hierarchical relations

<Image 
    src="/docs/docimages/concepts/tabular-sd/graph-structure-external-link.svg" 
    alt="Graph structure - non-hierarchical relations" 
    width={450} 
    height={150}
/>
...
| -- | -- |
| <GreenTickSign/> | Referential integrity is preserved |
| <GreenTickSign/> | Correlations between customers and logins are retained |
| <GreenTickSign/> | Correlations between all logins of the same customer are retained |
| <YellowWarningSign/> | Correlations between logins and accounts are NOT retained |
| <YellowWarningSign/> | Correlations between logins to the same account are NOT retained. In particular, the cardinality of the relationship is NOT retained. |
| <GreenTickSign/> | Privacy of all entities is protected |

### Graph schemas - Self-relation

<Image 
    src="/docs/docimages/concepts/tabular-sd/graph-structure-self-link.svg" 
    alt="Graph structure - self-relation" 
    width={200} 
    height={150}
/>
