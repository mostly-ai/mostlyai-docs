...
3. Select a cloud storage connector.
    ...
    <Image 
        ...
        height={150}
    />
4. Define the bucket path to your table, where **Table path** is the folder path, and **Table name** is the filename.
    <Image
        src="/docs/docimages/generators/add-data/from-cloud-storage-03-define-table-path.webp" 
