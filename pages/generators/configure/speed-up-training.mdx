...
<Image
   src="/docs/docimages/generators/speed-up-training/model-configuration-01-select-speed-preset.webp"
...
<Image
   src="/docs/docimages/generators/speed-up-training/model-configuration-02-select-turbo-preset.webp"
...
3. Set the **Max sample size** as number of rows.
    <Image
        src="/docs/docimages/generators/speed-up-training/model-configuration-03-decrease-max-sample-size.webp"
...
3. Set the **Max training time** in minutes.
    <Image
        src="/docs/docimages/generators/speed-up-training/model-configuration-04-decrease-training-time.webp"
...
3. For **Model**, select **MOSTLY_AI/Small**.
    <Image
        src="/docs/docimages/generators/speed-up-training/model-configuration-05-reduce-model-size.webp"
...
3. Adjust the **Batch size**.
   ...
   2. Otherwise, set the batch size to a powers of 2 integer from the listed options.
    ...
    <Image
        src="/docs/docimages/generators/speed-up-training/model-configuration-06-increase-batch-size.webp"
