...
<Image
   src="/docimages/generators/configure-time-series/time-series-01-set-context-relationships.webp"
...
<Image
    src="/docimages/generators/configure-time-series/max-sequence-window.svg"
