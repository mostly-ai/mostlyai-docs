...
<Image 
   src="/docs/docimages/generators/configure-time-series/time-series-01-set-context-relationships.webp" 
   alt="MOSTLY AI - Generators - Time-series - Set context relationships" 
   width={800} 
   height={150}
/>
...
<Image
    src="/docs/docimages/generators/configure-time-series/max-sequence-window.svg"
    alt="MOSTLY AI - Generator configuration - Max sequence window"
    width={900}
    height={300}
/>
...
3. Adjust the **Max sequence window**.
    <Image
        src="/docs/docimages/generators/configure-time-series/time-series-02-adjust-max-sequence-window.webp"
