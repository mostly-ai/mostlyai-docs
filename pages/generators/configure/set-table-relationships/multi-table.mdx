...
1.  Download the [Berka dataset](/public-datasets/berka.zip) and add all tables to a new generator.
...
<Tabs.Tab>
1. Download the [Berka dataset](/public-datasets/berka.zip) and unzip.
