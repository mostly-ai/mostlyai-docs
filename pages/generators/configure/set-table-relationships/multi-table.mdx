...
<Image
    src="/docimages/generators/set-table-relationships/berka-table-relationships.webp"
...
<Image
    src="/docimages/generators/set-table-relationships/berka-hierarchy-relationships.webp"
...
1. Download the [Berka dataset](/datasets/berka.zip) and add all tables to a new generator.
    <Image
        src="/docimages/generators/set-table-relationships/multi-table-rel-01-add-berka-tables.webp"
...
<Image
    src="/docimages/generators/set-table-relationships/multi-table-rel-08-result-table-hierarchy.webp"
...
<Image
    src="/docimages/generators/set-table-relationships/berka-grandparent-child-exception.webp"
    alt="MOSTLY AI - Multi-table relationships - Set foreign keys for card table"
    width={900}
    height={300}
/>
