...
5. Upload the `purchases` table.
    1. In the generator, click **Add table**.
        <Image
            src="/docs/docimages/generators/set-table-relationships/table-rel-02-click-add-table.webp"
...
6. Set the relationship between the `customers` and `purchases` tables.
    ...
    3. Click **Modify**.
        <Image
            src="/docs/docimages/generators/set-table-relationships/table-rel-03-expand-table-relationships-click-modify.webp"
