...
<Image
    src="/docimages/generators/set-table-relationships/two-table.webp"
...
3. Upload the `customers` table.
    ...
    2. Upload the `customers` table, leave its name as `customers`, and click **Proceed**.<br />
        **Step result**: The table is now added to the generator.
        <Image
            src="/docimages/generators/set-table-relationships/table-rel-01-customers-added.webp"
...
5. Upload the `purchases` table.
    1. In the generator, click **Add table**.
        <Image
            src="/docimages/generators/set-table-relationships/table-rel-02-click-add-table.webp"
            alt="MOSTLY AI - Click Add table"
            width={800}
            height={300}
        />
...
6. Set the relationship between the `customers` and `purchases` tables.
    ...
    3. Click **Modify**.
        <Image
            src="/docimages/generators/set-table-relationships/table-rel-03-expand-table-relationships-click-modify.webp"
            alt="MOSTLY AI - Expand Table relationships and click Modify"
            width={800}
            height={300}
        />
    ...
    7. Click the confirmation button.
        <Image
            src="/docimages/generators/set-table-relationships/table-rel-04-configure-foreign-key.webp"
...
<Image
    src="/docimages/generators/set-table-relationships/table-rel-05-two-table-foreign-key-set.webp"
    alt="MOSTLY AI - Click Edit foreign keys"
    width={800}
    height={300}
/>
...
<Image
    src="/docimages/generators/set-table-relationships/table-rel-06-relationship-diagram-two-table.webp"
    alt="MOSTLY AI - Click Edit foreign keys"
    width={800}
    height={300}
/>
