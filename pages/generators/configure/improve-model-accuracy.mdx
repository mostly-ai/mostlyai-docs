...
<Image
   src="/docs/docimages/generators/improve-model-accuracy/model-configuration-00-select-accuracy-preset.webp"
   alt="MOSTLY AI - Generator configuration - Select Accuracy configuration preset"
   width={900}
   height={300}
/>
...
3. Set the **Max training time** in minutes.
    ...
    <Image
        src="/docs/docimages/generators/improve-model-accuracy/model-configuration-02-set-max-training-time.webp"
...
3. Set the **Max sample size** as number of rows.
    1. For subject tables, you set the number of rows to be used for training from the original subject table.
        <Image
            src="/docs/docimages/generators/improve-model-accuracy/model-configuration-01-set-max-sample-size-subjects.webp"
    ...
    2. For linked tables, you set the number of sequences (the sequences equal the number of subjects) to be used for training.
        ...
        <Image
            src="/docs/docimages/generators/improve-model-accuracy/model-configuration-01.01-set-max-sample-size-linked.webp"
...
3. For **Model**, select **MOSTLY_AI/Large**.
    ...
    <Image
        src="/docs/docimages/generators/improve-model-accuracy/model-configuration-03-increase-model-size.webp"
