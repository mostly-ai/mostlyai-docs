...
4. Expand **Differential privacy** and select **On** to enable differential privacy for the model.
    <Image
        src="/docimages/generators/enable-differential-privacy/01-enable-differential-privacy.webp"
...
4. Configure the differential privacy options.<br />
    ...
    **Note**<br />
    ...
    <Image
        src="/docimages/generators/enable-differential-privacy/02-configure-differential-privacy-epsilon-max-gradient-norm-noise-multiplier.webp"
...
<Image
    src="/docimages/generators/enable-differential-privacy/03-open-training-log.webp"
