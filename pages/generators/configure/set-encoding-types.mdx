...
1. On the generator **Data configuration** page, click a table to expand it and view its encoding types.
    <Image
        src="/docimages/generators/set-encoding-types/generator-01-highlight-and-click-table.webp"
...
2. Click in the **Encoding type** area for a column.
    <Image
        src="/docimages/generators/set-encoding-types/generator-02-select-encoding-type.webp"
