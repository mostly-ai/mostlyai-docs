...
When you [generate a synthetic dataset](/synthetic-datasets/generate), you leverage the LLM knowledge for additional categories that can representatively belong to the column.

### Language/Numeric

Use the **Language/Numeric** encoding type to fine-tune an LLM with the numeric data in the selected column from your dataset.

When you [generate a synthetic dataset](/synthetic-datasets/generate), you leverage the LLM knowledge for additional numeric values that can representatively belong to the column.

### Language/Datetime

Use the **Language/Datetime** encoding type to fine-tune an LLM with the date-time data in the selected column.

When you [generate a synthetic dataset](/synthetic-datasets/generate), you leverage the LLM knowledge for additional date-time values that can representatively belong to the column.
