...
* fine-tune a [HuggingFace LLM](https://huggingface.co/) with the text data in the selected column.

<CustomCallout>
The list of HuggingFace LLMs is [configurable](/administration/models) and can be extended. If a model you want to use is not available, contact [MOSTLY AI Support](mailto:support@mostly.ai).
</CustomCallout>
