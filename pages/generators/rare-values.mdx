...
<Image
    src="/docs/docimages/generators/rare-values/rare-category-protection-modes.webp"
    alt="Rare category protection modes - Constant and Sample"
    width={800}
    height={300}
/>
...
<Image
    src="/docs/docimages/generators/rare-values/columns-with-codes-character-column-type.webp"
    alt="Columns with codes - use Character column type"
    width={800}
    height={300}
/>
...
<Image
    src="/docs/docimages/generators/rare-values/set-primary-key.webp"
    alt="Set primary key"
    width={800}
    height={300}
/>
