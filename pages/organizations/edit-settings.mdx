...
Drag and drop a square logo (aspect ratio 1:1) into the upload area. There are no limitations on the logo size. The logo appears on the organization profile page and in the sidebar organizations list.
...
Write a captivating description for your organization. Use [Markdown](https://www.markdownguide.org/cheat-sheet/) to apply structure and formatting.
