...
You can find the organization display name in two positions: the _sidebar organizations list_ and the _organization profile_.
...
When you create the organization, the organization name is auto-generated based on the display name in all lower-case characters, hyphen-separated.

The organization name must be unique across all organizations on the MOSTLY AI Platform. Otherwise, you cannot change the organization name.
