...
2. Set the **Organization display name**.
    ...
    Certain rules apply to what characters you can use in the **display name** and in the **organization name**. For details, see [_About organization names_](#about-organization-names).
    </CustomCallout>
