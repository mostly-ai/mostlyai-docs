...
<Image src="/docimages/best-practices/subject-linked-tables-best-practices.webp" alt="Subject and linked tables - best practices" width={700} height={700} />
...
<Image src="/docimages/best-practices/example-geolocation-dataset-structure.webp" alt="Example: Geolocation dataset structure" width={300} height={700} />
...
<Image src="/docimages/best-practices/example-geolocation-dataset-structure-preprocessed.webp" alt="Example: Geolocation dataset structure" width={450} height={280} />
...
<div className="empty_header_table"></div>| | | | -- | -- | | **Bad univariate fit** | High number of N/As | | **High amount of rare category labels** | Incorrect encoding type | | **High number of business rules violations** | **Training goal** is set to **Speed** or **Turbo** instead of **Accuracy** |
...
<Image src="/docimages/best-practices/incorrect-numerical-example.webp" alt="Incorrect numerical" width={300} height={150} />
...
<Image src="/docimages/best-practices/incorrect-datetime-example.webp" alt="Incorrect datetime" width={300} height={150} />
...
<Image src="/docimages/best-practices/sequential-correlations-example.webp" alt="Sequential correlations are lost" width={800} height={150} />
