...
| |
|-|
| [Select a compute environment](synthetic-datasets/select-compute)                     |
| [Set sample size and temperature](synthetic-datasets/set-size-temp)                   |
| [Rebalance columns](synthetic-datasets/rebalance-columns)                             |
| [Impute data](synthetic-datasets/data-imputation)                                     |
| [Generate fair synthetic data](synthetic-datasets/fairness)                           |
| [Use a seed dataset for conditional generation](synthetic-datasets/seeded-generation) |
| [Evaluate quality](synthetic-datasets/evaluate-quality)                               |
| [Deliver to databases and cloud buckets](synthetic-datasets/deliver)                  |
{/* | [Preview synthetic data samples](synthetic-datasets/preview-data-samples)       | */}
