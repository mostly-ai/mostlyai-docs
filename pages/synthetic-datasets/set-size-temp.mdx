...
3. Set **Sample size** as the number of rows to generate.
    <Image
        src="/docimages/synthetic-datasets/set-size-temperature/set-size-01-rows.webp"
...
5. For **Top P**, use the slider to set a value in the range of `0.9` to `1.00`.
    <Image
        src="/docimages/synthetic-datasets/set-size-temperature/set-temp-topp-01-config.webp"
