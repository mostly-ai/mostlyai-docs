...
1. From a generator, click **Generate synthetic data** in the upper right.
...
1. From a generator, click **Generate synthetic data** in the upper right.
2. Expand the generation settings for a table.
3. For **Temperature**, use the slider to set a value in the range of `0` to `2`, where `0` is extremely conservative and `2` is extremely creative.
4. For **Top P**, use the slider to set a value in the range of `0.9` to `1.00`.
    <Image 
