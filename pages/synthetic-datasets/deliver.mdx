...
1. On the **Synthetic dataset configuration** page, click **Dataset destination**.
    <Image 
        src="/docs/docimages/synthetic-datasets/deliver/01-configure-01-click-dataset-destination.webp" 
        alt="Configure synthetic dataset destination" 
        width={800} 
        height={150}
    />
2. On the **Synthetic dataset destination** dialog, configure the destination.
    1. For **Destination**, select a database or cloud bucket destination.
        <Callout>
        The **Destination** drop-down lists only connectors that have the **Destination** access type. <br />You can type to filter the names among the list of destination connectors.
        </Callout>
        <Image 
            src="/docs/docimages/synthetic-datasets/deliver/01-configure-0X-select-destination.webp" 
            alt="Configure synthetic dataset destination - Select Destination" 
            width={800} 
            height={150}
        />
    2. For **Location**, select a database, database schema, or cloud bucket folder where you want to deliver the generated synthetic dataset.<br /><br />
        ...
        <Image 
            src="/docs/docimages/synthetic-datasets/deliver/01-configure-02-databases-location-drop-down.webp" 
            alt="Configure synthetic dataset destination - Location drop-down menu for databases" 
            width={800} 
            height={150}
        />  
        For cloud storage buckets, type the folder path in the **Location** text box.
        <Image 
            src="/docs/docimages/synthetic-datasets/deliver/01-configure-03-cloud-storage-location-text-box.webp" 
            alt="Configure synthetic dataset destination - Location drop-down menu for cloud buckets"
            width={800} 
            height={150}
        />
...
1. Get the ID of the destination connector.
    <Image 
        src="/docs/docimages/synthetic-datasets/deliver/00-configure-python-01-get-destination-connector-uuid.webp" 
...
2. Get the ID of the generator to use.
    <Image 
        src="/docs/docimages/synthetic-datasets/deliver/00-configure-python-02-get-generator-uuid.webp" 
