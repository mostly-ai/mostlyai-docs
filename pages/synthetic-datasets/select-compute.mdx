...
1. On the **Synthetic dataset configuration** page, click **Compute** in the upper right.
   <Image src="/docimages/synthetic-datasets/select-compute/01-click-compute.webp" alt="Configure a synthetic datasets - Select a compute environment - 01 - Click Compute" width={800} height={300} />
2. From the **Compute** pop-up window, select a compute.
   <Image src="/docimages/synthetic-datasets/select-compute/02-select-compute.webp" alt="Configure a synthetic datasets - Select a compute environment - 01 - Select compute" width={800} height={300} />
3. Click **Proceed**.
