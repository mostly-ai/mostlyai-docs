...
<Image
    src="/docimages/synthetic-datasets/rebalance-columns/cdnow-gender-distribution.webp"
...
4. For **Column**, click and select the column to rebalance. In this case, select **income**.
    <Image
        src="/docimages/synthetic-datasets/rebalance-columns/rebalance-01-select-to-rebalance-income.webp"
        alt="MOSTLY AI - Synthetic datasets - Rebalancing column"
        width={800}
        height={150}
    />
5. Under **Categories**, click **+ Add category**.
6. Select the category to rebalance.
   <Image
        src="/docimages/synthetic-datasets/rebalance-columns/rebalance-02-select-category-to-rebalance.webp"
...
7. Specify its new percentage and confirm.
    <Image
        src="/docimages/synthetic-datasets/rebalance-columns/rebalance-03-specify-rebalance-percentage.webp"
