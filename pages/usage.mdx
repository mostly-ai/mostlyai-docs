...
<CustomCallout>
**Note**
Longer chats consume tokens at a much higher rate. When discussing a new topic or performing a new analysis, start a new chat by clicking **New Chat** to conserve tokens.
</CustomCallout>
