...
For generators and synthetic datasets, you will find the virtual CPU/GPU time consumed in the **Training status** section. For chats, you will you will find the total token consumption as well as virtual CPU/GPU time consumed in the **Python Session status** section.
