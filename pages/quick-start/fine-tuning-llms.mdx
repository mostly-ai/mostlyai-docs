...
<Image
    src="/docimages/quickstart/unstructured-text/splash-unstructured-text.webp"
...
2. On the **Data configuration** page, for the columns containing unstructured text, make sure that **Language/Text** is selected as **Encoding type**.
    <Image
        src="/docimages/quickstart/unstructured-text/01-generator-configuration-01-select-language-text.webp"
...
4. On the **Model configuration** page, expand the `language` model and configure it.
    1. For **Model**, select one of the available language models for training.
        ...
        <Image
            src="/docimages/quickstart/unstructured-text/01-generator-configuration-02-select-language-model.webp"
    ...
    2. For **Compute**, select an available compute. We recommend the use of GPUs for language models.
        ...
        * **GPU-based** computes include a specific number of GPU cores and GPU memory. For language model fine-tuning and language generation, it is typically faster to use GPUs.
        ...
        <Image
            src="/docimages/quickstart/unstructured-text/01-generator-configuration-03-select-compute.webp"
...
5. Click **Start training** in the upper right.
    <Image
        src="/docimages/quickstart/unstructured-text/01-generator-configuration-04-click-start-training.webp"
...
1. Open the trained generator and click **Generate data** in the upper right.
    <Image
        src="/docimages/quickstart/unstructured-text/02-generate-unstructured-text-01-click-generate-data.webp"
...
3. Click **Start generation** in the upper right.
    <Image
        src="/docimages/quickstart/unstructured-text/02-generate-unstructured-text-02-click-start-generation.webp"
