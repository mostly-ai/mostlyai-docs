...
2. Click **+ New generator**.
   <Image src="/docimages/quickstart/model-creators/train-generator-01-click-new-generator.webp" alt="MOSTLY AI - Train a generator - 01 - Click New generator" width={800} height={150} />
3. Select **Upload file**, browse for a dataset, and click **Proceed**.
   ...
   <Image src="/docimages/quickstart/model-creators/train-generator-02-click-upload-files.webp" alt="MOSTLY AI - Train a generator - 02 - Click Upload files" width={800} height={150} />
4. At the **Data configuration** step, click **Configure models**.
   <Image src="/docimages/quickstart/model-creators/train-generator-03-click-configure-models.webp" alt="MOSTLY AI - Train a generator - 04 - Click Configure models" width={800} height={150} />
5. At the **Model configuration** step, click **Start training**.
   <Image src="/docimages/quickstart/model-creators/train-generator-04-click-start-training.webp" alt="MOSTLY AI - Train a generator - 04 - Click Start training" width={800} height={150} />
...
2. Click **Share**.
   <Image src="/docimages/organizations/add-assets-01-select-share.webp" alt="Share - 01 - Share button" width={700} height={300} />
3. Select the organization to share the resource to.
   <Image src="/docimages/organizations/add-assets-02-select-share-org.webp" alt="Share - 02 - Select organization" width={700} height={300} />
...
2. Click **Share**.
   <Image src="/docimages/quickstart/model-creators/make-public-01-select-share.webp" alt="MOSTLY AI - Make the generator publc - 02 - Select organization" width={800} height={150} />
3. Select **Public** and click **Save**.
   <Image src="/docimages/quickstart/model-creators/make-public-02-select-public.webp" alt="MOSTLY AI - Make the generator publc - 02 - Select organization" width={800} height={150} />

**Result**

Public generators of organizations are listed on the organization's profile page.

<Image src="/docimages/quickstart/model-creators/make-public-03-public-generator-org-profile.webp" alt="MOSTLY AI - Make the generator publc - 03 - Public generator on organization profile" width={800} height={150} />

They are also available on the **Generators** page for all logged-in users.

<Image src="/docimages/quickstart/model-creators/make-public-04-public-generator-user-generators-list.webp" alt="MOSTLY AI - Make the generator publc - 04 - Public generator on user's Generators list" width={800} height={150} />
