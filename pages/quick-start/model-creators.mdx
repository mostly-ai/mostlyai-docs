...
2. Click **+ New generator**.
    <Image
        src="/docimages/quickstart/model-creators/train-generator-01-click-new-generator.webp"
...
3. Select **Upload file**, browse for a dataset, and click **Proceed**.
    ...
    **Note**<br />
    ...
    <Image
        src="/docimages/quickstart/model-creators/train-generator-02-click-upload-files.webp"
...
4. At the **Data configuration** step, click **Configure models**.
    <Image
        src="/docimages/quickstart/model-creators/train-generator-03-click-configure-models.webp"
...
5. At the **Model configuration** step, click **Start training**.
    <Image
        src="/docimages/quickstart/model-creators/train-generator-04-click-start-training.webp"
