...
2. Click the kebab menu and select **Transfer ownership**.
    <Image
        src="/docs/docimages/quickstart/model-creators/transfer-to-org-01-kebab-select-transfer-ownership.webp"
        alt="MOSTLY AI - Make the generator publc - 01 - Select Transfer ownership"
        width={800}
        height={150}
    />
3. Select your organization and click **Save**.
    <Image
        src="/docs/docimages/quickstart/model-creators/transfer-to-org-02-select-org.webp"
...
2. Click the kebab menu and select **Manage visibility**.
    <Image
        src="/docs/docimages/quickstart/model-creators/make-public-01-select-manage-visibility.webp"
        alt="MOSTLY AI - Make the generator publc - 02 - Select organization"
        width={800}
        height={150}
    />
