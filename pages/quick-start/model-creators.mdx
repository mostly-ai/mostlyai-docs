...
2. Click **Share**.
    <Image
        src="/docimages/quickstart/model-creators/make-public-01-select-share.webp"
...
3. Select **Public** and click **Save**.
    <Image
        src="/docimages/quickstart/model-creators/make-public-02-select-public.webp"
        alt="MOSTLY AI - Make the generator publc - 02 - Select organization"
        width={800}
        height={150}
    />
...
<Image
    src="/docimages/quickstart/model-creators/make-public-03-public-generator-org-profile.webp"
...
<Image
    src="/docimages/quickstart/model-creators/make-public-04-public-generator-user-generators-list.webp"
