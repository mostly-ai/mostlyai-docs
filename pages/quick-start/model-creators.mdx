---
title: 'Quick start: Generators'
description: 'Model creators build generators that can be used to create privacy-safe synthetic data.'
---
...
Generators are models trained on data and used to create synthetic data based on your requirements. See [Generators](/generators) for more information about how generators are trained and the models offered by MOSTLY AI or see [Fine-tuning LLMs](/fine-tuning-llms) for instructions on using your own large language model.
...
To generate synthetic data, see [Quickstart: Synthetic data](data-consumers).
