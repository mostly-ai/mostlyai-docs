...
1. From the profile menu, select **Compute**.
   <Image src="/docimages/administration/compute/01-profile-menu-select-compute.webp" alt="MOSTLY AI - Profile menu - Select Compute" width={800} height={15000} />
2. Click **+ New compute**.
   <Image src="/docimages/administration/compute/02-click-new-compute.webp" alt="MOSTLY AI - Click New Compute" width={800} height={15000} />
3. Select **Kubernetes**.
   <Image src="/docimages/administration/compute/02.01-select-kubernetes.webp" alt="MOSTLY AI - Select Kubernetes" width={800} height={15000} />
4. Define the compute configuration.
   ...
   <Image src="/docimages/administration/compute/03-new-kubernetes-compute.webp" alt="MOSTLY AI - New Kubernetes compute" width={800} height={15000} />
5. Click **Save**.
...
<Image src="/docimages/administration/compute/05-result-select-compute.webp" alt="MOSTLY AI - Result - Select Compute" width={800} height={15000} />

In addition, the new compute remains available in the **Computes** list.

<Image src="/docimages/administration/compute/04-new-compute-available.webp" alt="MOSTLY AI - New Compute available" width={800} height={15000} />
