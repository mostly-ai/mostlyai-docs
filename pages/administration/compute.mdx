...
1. From the profile menu, select **Compute**.
    <Image
      src="/docimages/administration/compute/01-profile-menu-select-compute.webp"
...
2. Click **+ New compute**.
    <Image
      src="/docimages/administration/compute/02-click-new-compute.webp"
...
3. Select **Kubernetes**.
    <Image
      src="/docimages/administration/compute/02.01-select-kubernetes.webp"
...
3. Define the compute configuration.
    ...
    <Image
      src="/docimages/administration/compute/03-new-kubernetes-compute.webp"
...
<Image
    src="/docimages/administration/compute/05-result-select-compute.webp"
...
<Image
    src="/docimages/administration/compute/04-new-compute-available.webp"
