...
For more information on all supported storage classes, see [Storage classes](https://mostly.ai/docs/install/architecture#supported-kubernetes-storage-classes).