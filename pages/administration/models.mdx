...
<Callout>
Internet connection is required to download HuggingFace models. Contact MOSTLY AI to learn how to add models if internet connectivity is not available for your deployment due to security policies.
</Callout>