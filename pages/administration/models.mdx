...
6. Click **Create token**.
    <Image
        src="/docimages/administration/models/hugging-face-token-01-create-token.webp"
...
7. Copy your new token.
    <Image
        src="/docimages/administration/models/hugging-face-token-02-copy-token.webp"
...
1. In MOSTLY AI, select **Models** from the profile menu.
    <Image
        src="/docimages/administration/models/configure-models-01-profile-select-models.webp"
...
3. Under **Available models**, list the models you want to make available.<br />
    ...
    ```
    <Image
        src="/docimages/administration/models/01-configure-huggingface-models.webp"
