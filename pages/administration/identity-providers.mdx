...
4. Click on **Plus** icon next to the **Application** title.
    <Image
        src="/docimages/administration/identity-providers/02-create-pingone-app-01-click-plus-button.webp"
...
6. Click **Save**.
    <Image
        src="/docimages/administration/identity-providers/02-create-pingone-app-02-configure-app-and-save.webp"
        alt="Create a PingOne application - Click Plus button"
        width={800}
        height={300}
    />
...
<Image
    src="/docimages/administration/identity-providers/02-create-pingone-app-03-result-copy-details.webp"
    alt="Create a PingOne application - Click Plus button"
    width={800}
    height={300}
/>
...
2. From the drop-down in the upper left, select **mostly-generate**.
    <Image
        src="/docimages/administration/switch-realm-01-select-mostly-generate.webp"
...
4. Click **Add provider** and select **OpenID Connect v1.0**.
    <Image
        src="/docimages/administration/identity-providers/01-create-new-id-provider-01-click-add-and-openid-connect-1.0.webp"
...
5. Configure PingOne identity provider.
    ...
    6. Click **Add**.
        <Image
            src="/docimages/administration/identity-providers/01-create-new-id-provider-02-configure-pingone.webp"
...
6. Scroll down. Under **Advanced settings**, enable **Trust email**.
    <Image
        src="/docimages/administration/identity-providers/01-create-new-id-provider-03-enable-trust-email.webp"
...
3. Click the edit icon and configure the **Token Auth Method** and **Signoff URL**.
    ...
    For example:
        ...
        * `IDP_ALIAS` with the Keycloak IdP alias.
        ...
        ```
        <Image
            src="/docimages/administration/identity-providers/03-configure-ping-one-01-token-auth-method-and-signoff-url.webp"
...
<Image
    src="/docimages/administration/identity-providers/app-landing-page-with-pingone.webp"
