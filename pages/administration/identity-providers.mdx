...
You can also refer to [Organizations](/organizations) to learn how you can add users to organizations and use [role-based access](/organizations/roles-and-permissions) to control access to synthetic data resources.