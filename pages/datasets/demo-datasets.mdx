...
Click [here](/public-datasets/us-census-income.csv.gz) to download the `.csv.gz` file.
...
Click [here](/public-datasets/baseball.zip) to download the `.zip` file. It includes the `players.csv` and `seasons.csv` files.
...
Click [here](/public-datasets/CDNOW_CRM_table.csv.gz) to download the the `.csv.gz` file.
...
Click [here](/public-datasets/CDNOW_dataset.zip) to download the `.zip` file. It includes the `customers.csv` and `purchases.csv` tables.
...
Click [here](/public-datasets/netflix_10k.zip) to download the `.zip` file.
