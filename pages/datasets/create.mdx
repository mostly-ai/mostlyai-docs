...
The [Assistant](../assistant.mdx) can read your description and use it to gather insights about your dataset so treating it like a [prompt](../assistant/prompt-examples.mdx) is a great idea.
