...
* **Sharing of generators, synthetic datasets, connectors, or assistant threads**: Get notified when a user shares an entity with you.

## Open a notification

When you click on a notification, the browser redirects you to the corresponding entity (generator, synthetic dataset, connector, or assistant thread).
