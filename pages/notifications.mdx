...
* **Sharing of generators, synthetic datasets, connectors, or assistant chats**: Get notified when a user shares an entity with you.
...
When you click on a notification, the browser redirects you to the corresponding entity (generator, synthetic dataset, connector, or assistant chat).
