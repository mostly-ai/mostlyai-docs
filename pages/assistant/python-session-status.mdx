...
description: "Each new Assistant thread runs a Python environment where MOSTLY AI runs the Python code to navigate you and show you data insights. The Python session becomes inactive after a period of inactivity but can restart automatically. Learn how to check and manage your Python session status."
---
