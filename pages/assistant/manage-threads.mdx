...
2. In the upper left, click the **Arrow** button close to the thread name.
    <Image
    ...
    />
3. Click on Rename.
4. Enter a new name for the thread.
...
1. Export in one of two ways.
    ...
    * With the Assistant thread open, in the upper left, click the **Arrow** button close to the thread name.
        <Image
