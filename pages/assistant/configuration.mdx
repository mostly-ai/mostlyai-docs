...
description: 'When you deploy MOSTLY AI, the Assistant is included as part of the deployment. For the Assistant to work, you need to configure access to the Large Language Model (LLM).'
---
