...
description: "When you deploy MOSTLY AI, the Assistant is included as part of the deployment. For the Assistant to work, you need to configure access to the Language Learning Model (LLM) and DataLLM."
---
...
1. From the **Account** menu, select **Assistant settings**.
    ...
    <Image
        src="/docs/docimages/assistant/ai-assistant-configuration.webp"
        alt="MOSTLY AI - Assistant configuration"
        width={800}
        height={400}
    />
...
For DataLLM API key, go to https://data.mostly.ai and get an API key for DataLLM.
...
2. Define a set of instructions that modify the existing ones defined by MOSTLY AI.
    <Image
        src="/docs/docimages/assistant/ai-assistant-configuration-custom-instructions.webp"
        alt="MOSTLY AI - Assistant custom instructions"
        width={800}
        height={400}
    />
