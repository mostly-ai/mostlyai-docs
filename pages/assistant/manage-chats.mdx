...
When you create a new chat it is called **New Chat**. After the first message back and forth, the Assistant automatically provides a helpful name for the chat but you can always rename it yourself to make it easier to find and manage. This name is updated periodically as the conversation continues.
...
2. In the upper left, click the **Arrow** button close to the chat name.
   <Image src="/docimages/assistant/rename-chat-01-click-edit.webp" alt="MOSTLY AI - Assistant - Rename a chat - Click Edit" width={800} height={400} />
3. Click on **Rename**.
...
1. Export in one of two ways.
   ...
   - With the Assistant chat open, in the upper left, click the **Arrow** button close to the chat name.
     <Image src="/docimages/assistant/assistant-chat-export-as-ipynb.webp" alt="MOSTLY AI - Assistant - Export as Jupyter Notebook - Click kebab menu" width={800} height={400} />
