...
You can upload datasets from a local file system like your hard drive or use a [connector](./connector.mdx) to upload from a remote location.

## Create a dataset

For step-by-step instructions on how to upload a dataset, see [Create a dataset](datasets/create.mdx).

To work with demo datasets hosted by MOSTLY AI, check out [Demo datasets](./demo-datasets.mdx). The [Assistant](./assistant.mdx) also has access to several default datasets available out of the box.
