...
The [Synthetic Data SDK by MOSTLY AI](https://github.com/mostly-ai/mostlyai?tab=readme-ov-file#synthetic-data-sdk-) enables full programmatic use of the MOSTLY AI Platform features both in a local environment as well as by connecting to the MOSTLY AI Platform.
...
<Callout>For a complete API reference, see the [Synthetic Data SDK package documentation](https://mostly-ai.github.io/mostlyai/).</Callout>
...
| **Installation**  | Install the Python SDK in Local mode                    | 1. Deploy MOSTLY AI Platform in a Kubernetes cluster<br />2. Connect to the Platform with Python SDK in Client mode |
...
1. Hover over the profile menu in the upper right and select **API key**.
   <Image src="/docimages/python-sdk/api-key/01-profile-select-API-key.webp" alt="MOSTLY AI - Python SDK - From the Profile menu select API key" width={250} height={250} />
2. Click **Generate API Key**.
   <Image src="/docimages/python-sdk/api-key/02-generate-api-key.webp" alt="MOSTLY AI - Python SDK - Click Generate API key" width={800} height={150} />

**What's next**

Your key is immediately copied to your clipboard. You can now use it for the REST API or to instantiate your Synthetic Data SDK in Client mode.

## Examples

As you explore the [Generators](/generators), [Synthetic datasets](/synthetic-datasets), and [Connectors](/connectors) pages, you will find Python code snippets that show how to accomplish a task with the Synthetic Data SDK. Use the **UI** tab for the UI steps in the MOSTLY AI Platform and the **Python SDK** tab to switch between UI steps in the Platform and how to accomplish the same with the Synthetic Data SDK.
