...
1. Hover over the profile menu in the upper right and select **API key**.
   <Image src="/docimages/python-sdk/api-key/01-profile-select-API-key.webp" alt="MOSTLY AI - Synthetic Data SDK - From the Profile menu select API key" width={250} height={250} />
2. Click **Generate API Key**.
   <Image src="/docimages/python-sdk/api-key/02-generate-api-key.webp" alt="MOSTLY AI - Synthetic Data SDK - Click Generate API key" width={800} height={150} />
