...
<Callout>
For a complete API reference, see the [Python SDK package documentation](https://mostly-ai.github.io/mostlyai/).
</Callout>
...
1. Hover over the profile menu in the upper right and select **API key**.
    <Image 
        src="/docs/docimages/python-sdk/api-key/01-profile-select-API-key.webp" 
...
2. Click **Generate API Key**.
    <Image 
        src="/docs/docimages/python-sdk/api-key/02-generate-api-key.webp" 
