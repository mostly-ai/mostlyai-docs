...
1. With a generator, synthetic dataset, or connector open, click the kebab menu and select **Manage visibility**.
    <Image
        src="/docimages/organizations/visibility-01-kebab-select-manage-visibility.webp"
...
2. Select whether the resource should be made **Public**, **Private**, or **Unlisted**.
    <Image
        src="/docimages/organizations/visibility-02-select-public-private-unlisted.webp"
