...
<UnlistedResourceIcon/>You can also make generators, synthetic datasets, connectors, and assistant threads **unlisted**. Unlisted resources are not visible in public resource lists, but anyone with the link can access them.
...
| Assistant threads  | <PrivateResourceIcon/>Private | <PrivateResourceIcon/>Private<br /><UnlistedResourceIcon/>Unlisted<br /><br />Can also be [exported and shared as a Jupyter Notebook](/assistant/manage-threads#export-as-a-jupyter-notebook) | Cannot be transferred to an organization                       |
