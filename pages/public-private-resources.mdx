...
[Assistant chats](/assistant) are always private and cannot be made public. You can, however, [export an assistant chat as a Jupyter Notebook](/assistant/manage-chats#export-as-a-jupyter-notebook).
...
| Assistant chats  | <PrivateResourceIcon/>Private | <PrivateResourceIcon/>Private<br /><UnlistedResourceIcon/>Unlisted<br /><br />Can also be [exported and shared as a Jupyter Notebook](/assistant/manage-chats#export-as-a-jupyter-notebook) | Cannot be transferred to an organization                       |
