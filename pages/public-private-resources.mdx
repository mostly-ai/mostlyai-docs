...
| Assistant threads  | <PrivateResourceIcon/>Private | <PrivateResourceIcon/>Private<br /><UnlistedResourceIcon/>Unlisted<br /><br />Can also be [exported and shared as a Jupyter Notebook](/manage-threads#export-as-a-jupyter-notebook) | Cannot be transferred to an organization                       |
