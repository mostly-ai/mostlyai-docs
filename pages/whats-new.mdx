...
* Make generators, synthetic datasets, and connector to public visibility (they are automatically available to all users of the platform and listed publicly on your profile)
...
* {/* MSD-1321 */} After an organization is deleted (and, as a result, all of its resources), all resource lists are updated automatically (without the need to refresh the page)
