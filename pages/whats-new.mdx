...
For details, see [_Export as Jupyter Notebooks_](/chats/manage-chats#export-as-a-jupyter-notebook).
...
For details, see [Upload files in Assistant chats](/chats#upload-files).
