...
### Assistant artifacts
{/* MSD-1658 */}
The Assistant now supports **artifacts**, allowing it to display resources (like Generators or Synthetic datasets) and files (e.g. CSV, TXT) directly in your threads. A more interactive and organized way to work with results.
