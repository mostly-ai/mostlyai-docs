...
{/* MSD-XXXX */}
The [MOSTLY AI MCP Server](https://github.com/mostly-ai/mostly-mcp-server) is now available in beta, offering 19 powerful tools to supercharge your synthetic data workflows. It seamlessly integrates with four leading MCP clients:
