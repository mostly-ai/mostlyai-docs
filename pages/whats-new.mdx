...
Adds Datasets as a new resource type, allowing users to upload files via a dedicated `FILE_UPLOAD` connector. Users can access datasets through [connectors](./connectors.mdx), select specific locations as the [Assistant’s](./assistant.mdx) initial focus, and use a new “Use a Dataset” thread action that injects a dataset-related prompt. A dedicated Artifact view for Datasets is introduced, similar to Connectors, displaying a list of available datasets. Sharing is supported, with owners receiving warnings before sharing and recipients seeing metadata alongside clear notices for any restricted connectors.
...
* {/* MSD-1877 */} Platform: New homepage design 
...
<Image
    src="/docimages/release-notes/v228-job-failure-heartbeat-error.webp"
...
<Image
    src="/docimages/release-notes/v228-download-logs-failed-job.webp"
...
<Image
    src="/docimages/release-notes/v223-search-drop-downs-schemas-tables.webp"
...
<Image
    src="/docimages/common/redesigned-navigation.gif"
