...
* {/* MSD-1251 */} Fixed the alignment of the info icon for the **Foreign key** tooltip
...
* {/* MSD-1322 */} Fixed a misalignment in the **Generate data** button
* {/* MSD-1328 */} Fixed an issue with the unexpected expiration of organization invitations
