...
### `NUMERIC`, `DATETIME`, and `CATEGORICAL` encoding types for fine-tuned LLMs
{/* MSD-965 */}

Leverage the knowledge of LLMs by fine-tuning data columns with the new `LANGUAGE/NUMERIC`, `LANGUAGE/DATETIME`, and `LANGUAGE/CATEGORICAL` encoding types even for small training data sample sizes.
