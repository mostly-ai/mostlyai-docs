...
- {/* MSD-XXX */} Improve simulation features to include seed functionality for sequence compleation, supporting the creation of realistic data based on unseen series via [Synthetic Data SDK](https://github.com/mostly-ai/mostlyai?tab=readme-ov-file#synthetic-data-sdk-).
