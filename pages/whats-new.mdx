...
* {/* MSD-1837 */} Platform - Enhance [resource sharing experience](https://mostly.ai/docs/organizations/manage-resources/#transfer-a-resource-to-an-organization)
...
* {/* MSD-1854 */} [Assistant](https://mostly.ai/docs/assistant/): Minor UI Improvements
