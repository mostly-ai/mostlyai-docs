...
### Assistant artifacts
{/* MSD-1658 */}
The Assistant now supports **artifacts**, allowing it to display resources (like generators or synthetic datasets) and uploaded files (e.g. CSV, TXT) directly in your threads. A more interactive and organized way to work with results.
...
* Upgraded to SDK 4.7.0, ENGINE 1.4.2, QA 1.9.6
