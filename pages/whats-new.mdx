...
* {/* MSD-1251 */} Resolves the alignment of the info icon for the **Foreign key** tooltip
...
* {/* MSD-1322 */} Resolves a misalignment in the **Generate data** button
* {/* MSD-1328 */} Resolves an issue with the unexpected expiration of organization invitations
...
* establish an organization for your team to collaborate, contribute, and share synthetic data assets
* develop an organization's portfolio of synthetic data assets (generators, synthetic datasets, and connectors)
* use role-based access (RBAC) to manage the roles and permissions team members have with regard to synthetic data assets
* empower organizations to make synthetic data assets public by managing their visibility
...
You can now change the visibility of your generators, synthetic datasets, and connectors (referred to as _assets_, for brevity).

* You can share assets with everyone on the Platform by making them **public**.
* You can keep assets **private** (their default state after an asset is created).
* Apply the same visibility settings to an organization's assets.

For details, see [_Public and private assets_](/public-private-assets)

## v4.0.0
_Jan 23rd, 2024_

### MOSTLY AI releases the most advanced synthetic data open SDK 🎉
...
The [MOSTLY AI Synthetic Data SDK](https://github.com/mostly-ai/mostlyai-private) is an open source Python library that transfers the capabilities of producing AI-generated synthetic data back into local compute environments.

1. Install the open MOSTLY AI SDK.
    ```sh filename="shell" copy
    pip install -U mostlyai
    ```
2. Generate synthetic data in your local environment.
    ```python filename="python" copy
    # 1. Import the MOSTLY AI SDK and pandas
    from mostlyai.sdk import MostlyAI
    import pandas as pd

    # 2. Initialize the MOSTLY AI SDK.
...
To support the Open SDK and the MOSTLY AI open source initiative, you can now review the contents of MOSTLY AI generators. Export and import of generators is now available as unencrypted ZIP files.

### Semantic versioning

With the release of MOSTLY AI Platform and MOSTLY AI SDK version 4.0.0, all future releases will follow semantic versioning. For details, see [_Release lifecycle and support_](/release-lifecycle).
