...
* {/* MSD-1897 */} New homepage design
* {/* MSD-1880 */} Datasets available in public API
* {/* MSD-1872 */} Resource usage tracking for popularity sort

### Enhancements

* {/* MSD-1877 */} New sidebar menu with list of chats
...
* {/* MSD-1837 */} Platform - Enhance [resource sharing experience](https://docs.mostly.ai/organizations/manage-resources/#transfer-a-resource-to-an-organization)
