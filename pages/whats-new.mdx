...
The team at MOSTLY AI has been hard at work to introduce Organizations for all of our users and teams that want to collaborate on synthetic data projects. With Organizations, you can:
...
* Introduce role-based access (RBAC) to manage the roles and permissions team members have with regard to synthetic data assets
* Empower individual users and organizations to make assets public by managing their visibility

For details, see the related documentation sections.

* [_Organizations_](/organizations)
* [_Public and private assets_](/public-private-assets)
