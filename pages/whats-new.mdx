...
### Dynamic Interactive HTML Generation artifacts on the Assistant
{/* MSD-1839 */}
The Assistant now supports dynamic interactive HTML generation artifacts, enabling you to create rich, interactive visualizations and reports directly within your Assistant threads. This feature allows for more engaging and informative data presentations that can be shared and interacted with in real-time.

### Mostly MCP Server (beta)
{/* MSD-XXXX */}
Introducing the Mostly MCP Server in beta, providing 19 powerful tools for enhanced synthetic data workflows. The MCP Server is supported by 4 major MCP clients:

* **Claude Desktop** - Access MOSTLY AI capabilities directly from your desktop environment
...
* **Cursor** - Advanced AI-powered coding with MOSTLY AI integration

### Improvements

* {/* MSD-1810 */} Implemented periodic AWS license validation in the AWS marketplace offering, ensuring compliance and proper license management for AWS users.
