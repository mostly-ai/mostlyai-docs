...
- {/* MSD-XXXX */} Fix prompt caching for Anthropic models during MOSTLY AI Assistant Chats.
- {/* MSD-XXXX */} Fix exception handling for asynchronous LLM completion calls during MOSTLY AI Assistant Chats.
...
- {/* MSD-XXXX */} Downgraded to `ipykernel < 7` to improve stability for Python code execution in the Assistant.
- {/* MSD-XXXX */} Added automatic retry logic for Python code execution in the Assistant.
...
- {/* MSD-2286 */} Introducing the new and improved navigation bar for the MOSTLY AI Platform. Now you can get around faster, easier, and with fewer clciks than before.
...
- {/* MSD-2256 */} Now you can define Secrets for use by the [MOSTLY AI Assistant](/assistant) to make use of during Chats. Use Secrets to authetnicate API calls or store sensitive information that you don't want to be visible in the UI. With MOSTLY AI, you're in control.

### Enhancements

- {/* MSD-2208 */} Provide real-time [Credit](/usage#usage) calculations for your usage, ensuring you always know how much you've used and how much you have left.
- {/* MSD-XXX */} Increase process visbility during [Generator](/generators) training with enhanced progress messages.
- {/* MSD-XXX */} Improved foreign key matching ability for models with further fine-tuning.

### Resolved issues

- {/* MSD-2239 */} Enable social sharing previews in the [Artifact Library](/assistant/artifacts).
- {/* MSD-XXX */} Resolve issue with progress accuracy during [Generator](/generators) training showing Model Report generation as complete whilst still ongoing.
- {/* MSD-1943 */} Fix issues caused by table names in Generator configuration differing from the actual database table names.

### Upstream dependencies

- Upgraded [Synthetic Data SDK](https://github.com/mostly-ai/mostlyai) to `5.5.0`, [Synthetic Data Engine](https://github.com/mostly-ai/mostlyai-engine) to `1.7.0`, and mostly-mock to `0.2.2`.
...
- {/* MSD-2149 */} Non-context foreign keys are now supported by their own generative AI models. That means that every single foreign key in your dataset contains plausible values with respect to their parent primary key. Consider a case when you have a parent and a child. There are certain obvious things that must be true about their relationship: the parent must be a certain number of years older than the child. The parent should be assigned a certain gender based on their relationship to the child (mother, father). Now extrapolate that concept to less directly apparent relationships between data tables. With the deployment of non-context foreign key models, your synthetic data just got even smarter.

### Enhancements

- {/* MSD-2279 */} Show user first and last name instead of username throughout platform UI.
- {/* MSD-XXXX */} Enhanced login email design and content.

### Upstream dependencies

- Update [Synthetic Data SDK](https://github.com/mostly-ai/mostlyai) to`5.4.1`, and [Synthetic Data Engine](https://github.com/mostly-ai/mostlyai-engine) to `1.6.1`.
...
- {/* MSD-2186 */} We have seen a lot of community engagement around [creating and sharing Datasets](/datasets). To help you find the most popular datasets, we are now showing the most popular and trending Datasets on the platform homepage to make them even easier to explore.

### Assistant Message Queue

- {/* MSD-2263 */} Got a question for the [MOSTLY AI Assistant](/assistant)? Now you don't have to wait for an ongoing process to conclude before asking. The Assistant Message Queue allows you to send multiple messages before an ongoing process is completed. The MOSTLY AI Assistant just got a whole lot more autonomous.

### Improvements

- {/* MDS-2259 */} Introduce new platform homepage conversation starters with familiar MOSTLY AI platform actions: Analyze, Mock, Synthesize, Simulate
- {/* MSD-2214 */} Optimize [Artifact Library](/assistant/artifacts) experience for mobile users.
- {/* MSD-2251 */} Support Conditional Simulation features, even when Flexible Generation parameter is set to `off`.
- {/* MSD-2260 */} Display progress bars for Python tasks performed by the Assistant.

### Resolved issues

- {/* MSD-2221 */} Ensure that generated files created during Assistant Chats are synced to cloud storage to improve recovery during kernel restarts.
...
- {/* MSD-2167 */} Reduce token consumption during [Assistant](/assistant) chats by summarizing long running conversations in Assistant memory.

### Resolved issues

- {/* MSD-2205 */} Resolve issue with intermittent kernel starting issues.
- {/* MSD-2245 */} Support for deleting [Datasets](/datasets) if you have the appropriate permissions.
- {/* MSD-2241 */} Improve syntax and efficacy of UI error messages in the [Artifact library](/assistant/artifacts).
...
- {/* MSD-XXXX */} Increase the maximum number of tokens per LLM response from 5k to 20k.

### Resolved issues

- {/* MSD-XXXX */} Allow messages with only images to be sent to the [Assistant](/assistant) to prevent unexpected output.
...
- {/* MSD-2175 */} [Python sessions](/assistant/python-session-status) now have a **Stop session** option to manually stop the kernel.

### Improvements

- {/* MSD-2173 */} All platform entity pages ([Generators](/generators), [Synthetic datasets](/synthetic-datasets), [Connectors](/connectors), [Datasets](/datasets)) now have the Creator filter set to the logged in user by default.
- {/* MSD-2174 */} Standardize the position of the **Download** button across all [Artifacts](/assistant#artifacts).

### Resolved issues

- {/* MSD-2161 */} Resolve issue with accessing other user profiles on the MOSTLY AI Platform

### Upstream dependencies

- Upgraded [SDK](https://github.com/mostly-ai/mostlyai) to [`mostlyai 5.2.6`](https://github.com/mostly-ai/mostlyai/commits/main/)
- Upgraded [Platform](https://app.mostly.ai) to [`mostlyai-engine 1.5.7`](https://github.com/mostly-ai/mostlyai-engine/commits/main/)
- Upgraded [Pytorch](https://pytorch.org/) to [`2.8.0`](https://github.com/pytorch/pytorch/commits/v2.8.0)
- Upgraded [vLLM](https://vllm.ai/) to [`0.10.2`](https://github.com/vllm-project/vllm/commits/v0.10.2)
...
- {/* MSD-XXX */} Enhanced compatibility with Anthropic Claude [family of models](https://docs.claude.com/en/docs/about-claude/models/overview) for [Assistant](/assistant)
- {/* MSD-XXX */} [Assign descriptive chat title](https://docs.mostly.ai/assistant/manage-chats#rename-a-chat) after the first user message

### Resolved issues

- {/* MSD-2170 */} Fix sorting of recent chats in sidebar

### Upstream dependencies

- Upgraded [SDK](https://github.com/mostly-ai/mostlyai) to [`mostlyai 5.2.5`](https://github.com/mostly-ai/mostlyai/commits/main/)
- Upgraded [Platform](https://app.mostly.ai) to [`mostlyai-engine 1.5.6`](https://github.com/mostly-ai/mostlyai-engine)
...
- {/* MSD-2069 */} Standardize default naming for newly created resources
- {/* MSD-2109 */} Support preview images for HTML artifacts generated by the [Assistant](/assistant)
- {/* MSD-2137 */} Support downloading an uploaded file within a Chat (useful for accessing resources in Shared Chats)
- {/* MSD-2146 */} Extend [Assistant](/assistant) capabilities to include [computer vision](https://en.wikipedia.org/wiki/Computer_vision) for reviewing uploaded images

### Resolved issues

- {/* MSD-2013 */} Keep client connections active for long running prompts until [Assistant broker service](/install/architecture#application-nodes) has finished responding

### Upstream dependencies

- Upgraded [PostgreSQL](https://www.postgresql.org/docs/release/16.10/) to `16.10.0`
- Upgraded [Synthetic Data SDK](https://github.com/mostly-ai/mostlyai) to `mostlyai 5.2.4`
...
- {/* MSD-2063 */} When executing Python code in the Assistant, code block labels describe the purpose of the code block.

### Animated toasts for error notifications

- {/* MSD-2047 */} Error notifications now feature animated toasts to make them easier to recognize.

### Improvements

- {/* MSD-2066 */} Update modal pop-ups (Datasets & Synthetic Datasets)
- {/* MSD-2107 */} Show small Mostly AI icon on header for mobile devices to improve responsiveness
- {/* MSD-1808 */} Improve mobile responsiveness for Assistant modals
- {/* MSD-2132 */} Improve artifact sharing experience by adding filename and download URL as new properties

### Resolved issues

- {/* MSD-2120 */} Resolve issue with disordered messages when multiple streaming chats were active
- {/* MSD-2130 */} Redirect user to homepage when reaching parallel chat limit to make it easier to find the chat you want to continue
- {/* MSD-2085 */} Real-time credit update after generator/synthetic dataset job finishes to improve usage tracking

### Upstream dependencies

- Upgraded to [`mostlyai`](https://github.com/mostly-ai/mostlyai) 5.2.1
...
- {/* MSD-2056 */} Enable name save upon clicking Enter in Rename modal.
- {/* MSD-2058 */} Improve Markdown handling and rendering by the Assistant

### Resolved issues

- {/* MSD-2075 */} Patch new security vulnerabilities.
- {/* MSD-2083 */} Handle authentication error for asynchronous re-dispatches during artifact download.
- {/* MSD-XXX */} Resolve LiteLLM integration error.
...
- {/* MSD-1993/1996/2004/2005/2006/2007/2010 */} Enhance mobile responsiveness and UX.

### Resolved issues

- {/* MSD-1957 */} Fix issue caused by malformed [Assistant](/assistant) messages that prevented the chat from rendering.
- {/* MSD-2033 */} Ensure that latest [usage](/usage#usage) data is fetched at each request.
...
- {/* MSD-2004 */} Smoother mobile scrolling and rendering experience.
- {/* MSD-1987 */} Display [datasets](/datasets) for organizations and users.
- {/* MSD-1984 */} Code execution blocks better describe their purpose.
- {/* MSD-xxxx */} Shared [artificats](/artifacts) open in a new tab.

### Resolved issues

- {/* MSD-1990 */} Resolved issue where GIFs were not visible when shared.
- {/* MSD-1944 */} Prevent loading chats for unauthenticated users.
- {/* MSD-1953 */} Remove unnecessary scrollbars on homepage.
- {/* MSD-xxxx */} Resolve key seeding issue for Primary Key-only flat tables.
...
- {/* MSD-XXXX */} Resolved async thread pool exhaustion issue.
...
- {/* MSD-1989 */} Set default visibility for Artifacts to unlisted to improve sharing experience.
...
[Datasets](/datasets) are discrete collections of data created by a generator, uploaded to the platform directly, or accessed via connector. Build a dataset from scratch and [explore it with the Assistant](/assistant).

### Sharable Artifacts

Anything that you create with the MOSTLY AI [Assistant](/assistant) such as visualizations, GIFs, charts, and even datasets can be [shared](/public-private-resources) with your organization, other MOSTLY AI users, and the world. Contribute to public data intelligence today!

### Improvements

- {/* MSD-1971 */} Fullscreen modal for message artifacts
- {/* MSD-1913 / MSD-1914 / MSD-1915 */} Enhanced layout on connectors, generators, and synthetic datasets pages
- {/* MSD-1900 */} Support storage configuration for [compute resources](/administration/compute)

### Resolved issues

- {/* MSD-1937 */} Support for empty primary key during generator creation
- {/* MSD-1973 */} Improve mobile responsiveness
...
- {/* MSD-1892 */} Real-time credit updates for chat usage ensure accurate usage reporting.
...
- {/* MSD-1853 */} CORE - Support generator probing with exclusively language columns
- {/* MSD-xxxx */} Assistant - Resilient CSV handling for DataFrames
...
- {/* MSD-XXXX */} Enable file uploads during Assistant chats
