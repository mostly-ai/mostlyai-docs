...
description: 'The Search bar offers direct access to all of your generators, synthetic datasets, connectors, and assistant chats in MOSTLY AI. You also have dedicated search for each entity type. Each entity type you can also filter by the type of ownership: all, own, own organizations.'
---
...
The Search bar offers direct access to all of your [generators](/generators), [synthetic datasets](/synthetic-datasets), [connectors](/connectors), and [assistant chats](/assistant) in MOSTLY AI. You also have dedicated search for each entity type. Each entity type you can also filter by the type of ownership: all, own, own organizations.
