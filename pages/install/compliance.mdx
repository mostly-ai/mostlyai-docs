...
The secrets for each saved connector in MOSTLY AI are stored in the PostgreSQL database that is part of the MOSTLY AI application services. The secrets are encrypted at rest and in transit.