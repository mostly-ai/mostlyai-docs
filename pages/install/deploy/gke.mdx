...
2. Click the project menu at the top.
    <Image
        src="/docimages/install/gke/01-create-gcp-project-01-click-project-menu.webp"
...
3. Click **NEW PROJECT**.
    <Image
        src="/docimages/install/gke/01-create-gcp-project-02-click-NEW-PROJECT.webp"
...
4. On the **New Project** page, configure the new project.
    ...
    4. Click **CREATE**.
        <Image
            src="/docimages/install/gke/01-create-gcp-project-03-select-org-click-CREATE.webp"
...
5. Select the newly created project to work with.
    <Image
        src="/docimages/install/gke/01-create-gcp-project-04-select-new-project.webp"
...
1. From the Google Cloud Console, select **Kubernetes Engine** from the sidebar.
    <Image
        src="/docimages/install/gke/02-create-gke-cluster-01-select-kubernetes-engine.webp"
...
2. If not already enabled, click **ENABLE** to enable the Kubernetes Engine API.
    <Image
        src="/docimages/install/gke/02-create-gke-cluster-02-enable-kubernetes-engine-api.webp"
...
3. From the sidebar, select **Clusters** and click **CREATE**.
    <Image
        src="/docimages/install/gke/02-create-gke-cluster-03-clusters-click-create.webp"
...
4. Switch to standard cluster creation.
    <Image
        src="/docimages/install/gke/02-create-gke-cluster-04-switch-to-standard-cluster.webp"
...
6. Configure the number of nodes in the cluster.
    ...
    2. Under **Size**, set the **Number of nodes** to **1**.
        <Image
            src="/docimages/install/gke/02-create-gke-cluster-06-configure-nodes-count.webp"
...
4. Select a node type and configure the disk size.
    ...
    4. For **Boot disk size**, define at least **200GB**.
        <Image
            src="/docimages/install/gke/02-create-gke-cluster-07-node-type-disk-size.webp"
...
7. Click **CREATE** at the bottom.
    <Image
        src="/docimages/install/gke/02-create-gke-cluster-08-click-create.webp"
...
<Image
    src="/docimages/install/gke/02-create-gke-cluster-09-open-cluster.webp"
...
1. With the cluster open, click **CONNECT**.
    <Image
        src="/docimages/install/gke/03-connect-to-cluster-01-click-connect.webp"
...
4. In the modal window **Connect to the cluster**, copy the command to configure your cluster access.
    <Image
        src="/docimages/install/gke/03-connect-to-cluster-02-copy-connect-command.webp"
...
2. Select **MOSTLY AI Synthetic Data Platform BYOL**.
    <Image
        src="/docimages/install/gcp-marketplace/01-subscribe-01-open-mostly-ai-offerings.webp"
...
3. Click **GET STARTED**.
    <Image
        src="/docimages/install/gcp-marketplace/01-subscribe-02-byol-get-started.webp"
...
4. Select a Google Cloud project for MOSTLY AI, select the **Terms and agreements** checkbox, and click **AGREE**.
    <Image
        src="/docimages/install/gcp-marketplace/01-subscribe-03-select-project-click-agree.webp"
...
5. Click **DEPLOY** in the prompt.
    <Image
        src="/docimages/install/gcp-marketplace/01-subscribe-04-click-deploy.webp"
...
6. On the **Deploy MOSTLY AI** page, click **OR SELECT AN EXISTING CLUSTER**.
    <Image
        src="/docimages/install/gcp-marketplace/01-subscribe-05-select-cluster.webp"
...
7. For **Existing Kubernetes Cluster**, select your GKE cluster.
    <Image
        src="/docimages/install/gcp-marketplace/01-subscribe-06-select-cluster-02.webp"
...
8. For **Namespace**, select **Create a namespace**, and for **New namespace name** set `mostly-ai`.
    ...
    <Image
        src="/docimages/install/gcp-marketplace/01-subscribe-07-select-namespace.webp"
...
10. For **The domain name**, set a fully-qualified domain (FQDN) name for the MOSTLY AI app.
    <Image
        src="/docimages/install/gcp-marketplace/01-subscribe-08-set-fqdn.webp"
        alt="GCP Marketplace - Select namespace"
        width={800}
        height={150}
    />
...
<Image
    src="/docimages/install/gcp-marketplace/01-subscribe-09-deploy-in-progress.webp"
...
<Image
    src="/docimages/install/gcp-marketplace/01-subscribe-10-deploy-complete.webp"
