...
- [ ] Your Kubernetes cluster can access the **container image repository**.
    ...
    * If your internal IT policies require that you pull the images from an internal repository, ensure that your Kubernetes cluster has access to it. For more information, [Configure an internal image repository](../config/internal-image-repo).
