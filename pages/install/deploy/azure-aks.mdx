...
1. Log in to Microsoft Azure and select **Create a resource**.
    <Image
        src="/docimages/install/azure-aks/01-azure-01-select-create-a-resource.webp"
...
2. In the services search bar, type `aks` and press Enter.
    <Image
        src="/docimages/install/azure-aks/01-azure-02-search-aks.webp"
...
3. From the results, select **Azure Kubernetes Service (AKS)**.
    <Image
        src="/docimages/install/azure-aks/01-azure-03-select-azure-kubernetes-services.webp"
...
4. Click **Create**.
    <Image
        src="/docimages/install/azure-aks/01-azure-04-click-create.webp"
...
5. Configure the **Basics** page of the wizard.
    ...
    5. (Optional) For **Region**, select the region to use for the cluster.
        <Image
            src="/docimages/install/azure-aks/01-azure-05-basics-page.webp"
...
6. Configure the **Node pools** page of the wizard.
    1. For the **agentpool** node pool, click the **Node size** entry.
        <Image
            src="/docimages/install/azure-aks/01-azure-06-click-node-size.webp"
    ...
    2. On the **Update node pool** page, for **Node size** click **Choose a size**.
        <Image
            src="/docimages/install/azure-aks/01-azure-07-choose-node-size.webp"
    ...
    3. On the **Select a VM size** page, select **D8s_v3** and click **Select**.
        <Image
            src="/docimages/install/azure-aks/01-azure-08-select-vm-size.webp"
    ...
    4. Back on the **Update node pool** page, for **Scale method**, select **Manual** and leave **Node count** to **1**.
        <Image
            src="/docimages/install/azure-aks/01-azure-09-scale-node-count.webp"
    ...
    5. For the **userpool** node pool, click the **Node size** entry.
        <Image
            src="/docimages/install/azure-aks/01-azure-09.02-click-userpool-node-size.webp"
...
7. Configure the **Networking** page of the wizard.
    1. For **Network policy**, select **None**.
        <Image
            src="/docimages/install/azure-aks/01-azure-10-network-policy.webp"
...
10. If the final configuration validation completes, click **Create**.
    <Image
        src="/docimages/install/azure-aks/01-azure-11-config-validation-complete.webp"
        alt="Azure - Select Network policy - None"
        width={450}
        height={700}
    />
...
<Image
    src="/docimages/install/azure-aks/01-azure-12-cluster-creation-in-progress.webp"
    alt="Azure - Select Network policy - None"
    width={800}
    height={700}
/>
...
<Image
    src="/docimages/install/azure-aks/01-azure-13-cluster-deployment-complete.webp"
    alt="Azure - Select Network policy - None"
    width={800}
    height={700}
/>
...
1. From the AKS cluster page, click **Connect to cluster**.
    <Image
        src="/docimages/install/azure-aks/03-connect-to-cluster-01-cluster-page-connect.webp"
...
2. Copy and run the commands to connect to your cluster.
    <Image
        src="/docimages/install/azure-aks/03-connect-to-cluster-02-copy-commands.webp"
...
2. Select the `userpool` node pool.
    <Image
        src="/docimages/install/azure-aks/xx-taint-node-pools-01-select-userpool.webp"
...
3. For **Taints**, click **edit**.
    <Image
        src="/docimages/install/azure-aks/xx-taint-node-pools-02-click-edit-for-taints.webp"
...
4. Add the `engine-jobs` taint with the `NoSchedule` effect.
    ...
    4. Click **Save**.
        <Image
            src="/docimages/install/azure-aks/xx-taint-node-pools-03-define-taint.webp"
...
3. In Azure, go to your AKS cluster and select **Workloads**.<br />
    ...
    <Image
        src="/docimages/install/azure-aks/06-deploy-01-workloads-started.webp"
...
1. Obtain your cluster name and resource group name in Azure.
    ...
    <Image
        src="/docimages/install/azure-aks/uninstall-02-delete-cluster.webp"
