...
3. Click the **Security group** for the instance.
    <Image
        src="/docimages/install/minikube/00-aws-ec2-01-ec2-instance-security-group.webp"
...
3. For **Inbound rules** at the bottom, click **Edit inbound rules**.
    <Image
        src="/docimages/install/minikube/00-aws-ec2-02-edit-inbound-rules.webp"
...
5. Click **Save rules**.
    <Image
        src="/docimages/install/minikube/00-aws-ec2-03-select-type-and-cidr.webp"
...
<Image
    src="/docimages/install/minikube/01-rdp-01-get-ip-or-hostname.webp"
...
4. Double-click the new machine or right-click and select **Connect**.
    <Image
        src="/docimages/install/minikube/01-rdp-02-right-click-machine-connect.webp"
...
<Image
    src="/docimages/install/minikube/02-minikube-dashboard-default.webp"
