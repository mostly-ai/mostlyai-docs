...
1. From AWS Services, search and open **EC2**.
    <Image
        src="/docimages/install/aws-eks/02-key-pair-01-open-ec2.webp"
...
2. In **EC2**, select **Key Pairs** under **Network & Security** from the sidebar.
    <Image
        src="/docimages/install/aws-eks/02-key-pair-02-ec2-select-key-pair.webp"
...
3. Click **Create key pair**.
    <Image
        src="/docimages/install/aws-eks/02-key-pair-03-click-create.webp"
...
4. Enter a name for the new key pair and click **Create key pair**.
    ...
    * **Private key file format**: `.pem`
    ...
    <Image
        src="/docimages/install/aws-eks/02-key-pair-04-name-and-create.webp"
...
<Image
    src="/docimages/install/aws-eks/02-key-pair-05-result.webp"
...
1. From AWS Services, search and open **Identity and Access Management (IAM)**.
    <Image
        src="/docimages/install/aws-eks/03-user-group-01-open-iam.webp"
...
2. In **IAM**, select **User groups** from the sidebar.
    <Image
        src="/docimages/install/aws-eks/03-user-group-02-click-user-groups.webp"
...
3. Click **Create group**.
    <Image
        src="/docimages/install/aws-eks/03-user-group-03-click-create-group.webp"
...
4. Name the group **`eksctl-group`** and click **Create group**.
    <Image
        src="/docimages/install/aws-eks/03-user-group-04-name-the-group.webp"
...
<Image
    src="/docimages/install/aws-eks/03-user-group-05-result.webp"
...
3. Click **Add permissions** and select **Attach policies** from the drop-down menu.
    <Image
        src="/docimages/install/aws-eks/04-user-group-policies-01-permissions-attach-policies.webp"
...
3. Select the **`AdministratorAccess`** policy.
    <Image
        src="/docimages/install/aws-eks/04-user-group-policies-02-select-admin-access.webp"
...
5. Click **Add permissions**.
    <Image
        src="/docimages/install/aws-eks/04-user-group-policies-03-click-add-permissions.webp"
...
<Image
    src="/docimages/install/aws-eks/04-user-group-policies-04-result.webp"
...
2. Select **Users** from the sidebar.
    <Image
        src="/docimages/install/aws-eks/05-user-01-select-users.webp"
...
3. Click **Create user**.
    <Image
        src="/docimages/install/aws-eks/05-user-02-click-create-user.webp"
...
4. Name the user **`eksctl`** and click **Next**.
    <Image
        src="/docimages/install/aws-eks/05-user-03-name-and-click-next.webp"
...
5. On the **Set permissions** step, select the **`eksctl-group`** and click **Next**.
    <Image
        src="/docimages/install/aws-eks/05-user-04-select-user-group-click-next.webp"
...
5. On the **Review and create** step, click **Create user**.
    <Image
        src="/docimages/install/aws-eks/05-user-05-click-create-user.webp"
        alt="AWS IAM - click Create user"
        width={800}
        height={300}
    />
...
<Image
    src="/docimages/install/aws-eks/05-user-06-result.webp"
...
2. Click **Create access key**.
    <Image
        src="/docimages/install/aws-eks/06-user-access-key-01-click-create-access-key.webp"
...
5. Click **Next**.
    <Image
        src="/docimages/install/aws-eks/06-user-access-key-02-best-practices.webp"
...
6. Click **Create access key**.
    <Image
        src="/docimages/install/aws-eks/06-user-access-key-03-click-create-access-key.webp"
        alt="AWS IAM - Click Create access key"
        width={800}
        height={300}
    />
...
8. Click **Download .csv file** to download the access key locally.
    <Image
        src="/docimages/install/aws-eks/06-user-access-key-04-download-access-key.webp"
...
1. From AWS Services, search and open **Route 53**.
    <Image
        src="/docimages/install/aws-eks/08-hosted-zone-01-open-route.webp"
        alt="AWS Services - Open EC2"
        width={700}
        height={700}
    />
...
3. Click **Create hosted zone**.
    <Image
        src="/docimages/install/aws-eks/08-hosted-zone-02-route-53-click-create-hosted-zone.webp"
...
5. Click **Create hosted zone**.
    <Image
        src="/docimages/install/aws-eks/08-hosted-zone-03-name-click-create.webp"
        alt="AWS S3 - upload deployment files"
        width={550}
        height={300}
    />
...
6. From the **Records** table, copy the name servers for the hosted zone you created.
    <Image
        src="/docimages/install/aws-eks/08-hosted-zone-04-copy-name-servers.webp"
        alt="AWS S3 - upload deployment files"
        width={800}
        height={300}
    />
...
1. From AWS Services, search and open **Certificate Manager**.
    <Image
        src="/docimages/install/aws-eks/09-ssl-cert-01-open-cert-manager.webp"
        alt="AWS Services - Open EC2"
        width={700}
        height={700}
    />
...
3. Click **Request**.
    <Image
        src="/docimages/install/aws-eks/09-ssl-cert-02-cert-mgr-click-request.webp"
...
4. Select **Request a public certificate** and click **Next**.
    <Image
        src="/docimages/install/aws-eks/09-ssl-cert-03-public-cert-click-next.webp"
...
5. Configure and submit a certificate request.
    ...
    3. Click **Requst**.
        <Image
            src="/docimages/install/aws-eks/09-ssl-cert-04-name-dns-valid-request.webp"
    ...
    **Step result**: A notification indicates that the certificate requires further validation.
        <Image
            src="/docimages/install/aws-eks/09-ssl-cert-05-request-success-notification.webp"
            alt="AWS Certificate Manager - type FQDN select DNS validation and request"
            width={800}
            height={300}
        />
6. Validate you are the owner of your domain.
    ...
    2. Select the **Certificate ID** in a **Pending validation** status.
        <Image
            src="/docimages/install/aws-eks/09-ssl-cert-06-open-pending-valildation-request.webp"
    ...
    3. Copy the CNAME name and value and add them as a new CNAME record in your DNS provider.
        <Image
            src="/docimages/install/aws-eks/09-ssl-cert-07-copy-cname-name-value.webp"
...
<Image
    src="/docimages/install/aws-eks/09-ssl-cert-08-cert-issued.webp"
    alt="AWS Certificate Manager - copy CNAME name and value"
    width={800}
    height={300}
/>
...
6. Select the user to which you need to grant permissions.
    <Image
        src="/docimages/install/aws-eks/_new/xx-eks-cluster-01-iam-access-entries.webp"
...
7. Click **Add access policy.**
    <Image
        src="/docimages/install/aws-eks/_new/xx-eks-cluster-02-add-access-policy.webp"
...
8. Add the **AmazonEKSAdminPolicy** and **AmazonEKSClusterAdminPolicy** policies. Repeat the steps below for each.
    ...
    3. Click **Add access policy** in the bottom right.
        <Image
            src="/docimages/install/aws-eks/_new/xx-eks-cluster-03-add-access-policy-steps.webp"
...
3. Search for `nodeinstance` and open the `eksctl-mostly-ai-cluster-nodegroup-NodeInstanceRole-******` role.
    <Image
        src="/docimages/install/aws-eks/_new/xx-storage-permissions-01-select-nodeinstance-role.webp"
        alt="AWS IAM - Search for nodeinstance role"
        width={800}
        height={300}
    />
4. Click **Add permissions** and select **Attach policies**.
    <Image
        src="/docimages/install/aws-eks/_new/xx-storage-permissions-02-nodeinstance-role-attach-policy.webp"
        alt="AWS IAM - Search for nodeinstance role"
        width={800}
        height={300}
    />
5. Search for `ec2fullaccess`, select **AmazonEC2FullAccess** and click **Add permissions**.
    <Image
        src="/docimages/install/aws-eks/_new/xx-storage-permissions-03-select-ec2fullaccess-and-attach.webp"
        alt="AWS IAM - Search for nodeinstance role"
        width={800}
        height={300}
    />
...
2. At the start, set the application domain name to an FQDN. Do the same as listed below for `minio`.
    ...
    ```
2. Apply one of the configurations below depending on whether you intend to use TLS-encrypted access to the MOSTLY AI application.<br /><br />
    **➡️ You use a TLS certificate**. Replace `your-tls-secret` with the TLS secret name as defined in your cluster configuration.
    ...
    ...
    ```
    **➡️ You do not use a TLS certificate**. Replace the  `your-tls-secret` with an empty string and, for `global.tls`, set `enabled` to `false`.
    ```yaml filename="values.yaml" copy {4,9}
    _customerInstallation:
    ...
      deploymentSettings:
...
5. (Optional) If you intend to use the MOSTLY AI image repository at `quay.io/mostlyai`, set its secret in `mostlyRegistryDockerConfigJson`.
    ...
    ...
    ```
6. Set an AWS storage class in `_customerInstallation.deploymentSettings.persistenceStorageClass`. For example, set `gp2` for the default AWS storage class.
...
2. Click **Create record**.
    <Image
        src="/docimages/install/aws-eks/12-alb-domain-01-click-create-record.webp"
...
3. Configure the record.
    ...
    3. Under **Route traffic to**, select the following options:
        ...
        * From the search box, select the name of your ALB.
            <Image
                src="/docimages/install/aws-eks/12-alb-domain-02-configure-a-record.webp"
...
1. Open your FQDN in your browser.<br />
    **Step result**: You **Sign in** page for your MOSTLY AI deployment opens.
    <Image
        src="/docimages/install/minikube/02-minikube-dashboard-01-post-deployment-red.webp"
