...
3. Search for `nodeinstance` and open the `eksctl-mostly-ai-cluster-nodegroup-NodeInstanceRole-******` role.
    <Image 
        src="/docs/docimages/install/aws-eks/_new/xx-storage-permissions-01-select-nodeinstance-role.webp"
...
4. Click **Add permissions** and select **Attach policies**.
    <Image 
        src="/docs/docimages/install/aws-eks/_new/xx-storage-permissions-02-nodeinstance-role-attach-policy.webp"
        alt="AWS IAM - Search for nodeinstance role"
        width={800}
        height={300}
    />
5. Search for `ec2fullaccess`, select **AmazonEC2FullAccess** and click **Add permissions**.
    <Image 
        src="/docs/docimages/install/aws-eks/_new/xx-storage-permissions-03-select-ec2fullaccess-and-attach.webp"
        alt="AWS IAM - Search for nodeinstance role"
        width={800}
        height={300}
    />
