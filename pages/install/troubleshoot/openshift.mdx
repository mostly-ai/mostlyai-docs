...
5. For **Require SSL**, select **None**.
    <Image
        src="/docs/docimages/install/troubleshoot/openshift/ocp-troubleshoot-keycloak-turn-ssl-off.webp"
        alt="MOSTLY AI Deployment troubleshooting - Resolve Keycloak connection error"
        width={800}
        height={300}
    />
