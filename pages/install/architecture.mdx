...
<Image src="/docimages/install/mostly-ai-architecture-new.svg" alt="MOSTLY AI architecture diagram" width={800} height={30} />
...
| **mostly-gateway**<br /><br />`mostly-gateway`                   | Entry point for web application frontend of all MOSTLY AI services as well as Keycloak.                                                                      | Service       |
...
| **mostly-jupyter-hub**<br /><br />`mostly-jupyter-hub`           | Jupyter Hub. The base image for each Python session in the MOSTLY AI Assistant.                                                                              | Service       |
