...
| <AssistantBrokerIcon /> Assistant Broker | **mostly-assistant-broker**<br /><br />`mostly-assistant-broker`   | Components that manages Assistant communication with the LLM service and the thread sessions. | Service |
| <JupyterHubIcon /> Jupyter Hub           | **jupter-hub**<br /><br />`jupter-hub`                             | Manages Python sessions for the assistant service, providing isolated Jupyter environments for code execution. | Service |
