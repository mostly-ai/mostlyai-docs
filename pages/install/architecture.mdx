...
| `mostly-ai-minio`                                                | (OPTIONAL) Legacy shared storage service.                                                                                                                    | Service       |
...
- **Shared Storage**. Shared by various pods to store models, synthetic data, and others. You can use an external S3 compatible storage solution
