...
import { DatabaseIcon, Chip2Icon, PuzzleIcon, FileBadgeIcon, IngressIcon } from '@components/icons'
...
<Cards num={2}>
    ...
    <Cards.Card icon={<FileBadgeIcon />} arrow title="Domain TLS certificate" href="/install/config/domain-tls-cert" />
    <Cards.Card icon={<IngressIcon />} arrow title="Ingress controllers" href="/install/config/ingress-controllers" />
</Cards>
