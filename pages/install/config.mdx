...
import { DatabaseIcon, Chip2Icon, PuzzleIcon, FileBadgeIcon, Ingress2Icon } from '@components/icons'
...
<Cards num={2}>
    ...
    <Cards.Card icon={<Ingress2Icon />} arrow title="Ingress controllers" href="/install/config/ingress-controllers" />
</Cards>
