...
<Image src="/docimages/install/hardware-profiling/memory.webp" alt="MOSTLY AI - Hardware profiling - Memory usage" width={800} height={150} />

## Duration

<Image src="/docimages/install/hardware-profiling/duration.webp" alt="MOSTLY AI - Hardware profiling - Duration of AI training and generation" width={800} height={150} />
