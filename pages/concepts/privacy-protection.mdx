...
<Image src="/docs/docimages/concepts/privacy/original-data-no-relation-synthetic-data.svg" alt="No relation between original and synthetic data" width={250} height={500} />
...
<Image src="/docs/docimages/concepts/privacy/probabilistic-model.svg" alt="Probabilistic model with random draws" width={650} height={500} />
...
<Image src="/docs/docimages/concepts/privacy/model-overfitting-prevention.svg" alt="Model overfitting prevention" width={175} height={500} />
...
<Image src="/docs/docimages/concepts/privacy/rare-category-protection.svg" alt="Rare category protection" width={175} height={500} />
...
<Image src="/docs/docimages/concepts/privacy/extreme-value-protection.svg" alt="Extreme value protection" width={175} height={500} />
...
<Image
    src="/docs/docimages/concepts/privacy/extreme-seq-length-protection.svg"
    alt="Extreme sequence length protection"
    width={175}
    height={500}
/>
...
<Image
    src="/docs/docimages/concepts/privacy/default-privacy-options-value-protection-enabled.webp"
    alt="Value protection enabled"
    width={800}
    height={500}
/>
