...
<Image
    src="/docs/docimages/concepts/scp/six-table-schema.png"
...
<Image 
    src="/docs/docimages/concepts/scp/01-single-table.svg" 
...
<Image 
    src="/docs/docimages/concepts/scp/02-two-tables.svg" 
...
<Image
    src="/docs/docimages/concepts/scp/01-mostly-ai-same-table-siblings-context-2nd-record.svg"
...
<Image
    src="/docs/docimages/concepts/scp/01-mostly-ai-same-table-siblings-context-3rd-record.svg"
...
<Image 
    src="/docs/docimages/concepts/scp/03-three-tables.svg" 
...
<Image 
    src="/docs/docimages/concepts/scp/04-four-tables.svg" 
...
<Image 
    src="/docs/docimages/concepts/scp/05-five-tables.svg" 
    alt="Three tables - context are the parent and cross-table siblings"
    width={800} 
    height={90}
/>
...
<Image 
    src="/docs/docimages/concepts/scp/06-six-tables.svg" 
    alt="Three tables - context are the parent and cross-table siblings"
    width={800} 
    height={90}
/>
