...
description: 'A comprehensive overview of software release management and support policies, covering semantic versioning, end-of-support timelines, security update procedures, and recommended user practices.'
---
...
**Semantic versioning**. Releases follow a semantic versioning system. Each release is identified by a version number in the format `vX.Y.Z`, where:
